...
static void InitDefaultsOperationMetadataV1() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_OperationMetadataV1 =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsOperationMetadataV1}, {
      &protobuf_google_2fprotobuf_2ftimestamp_2eproto::scc_info_Timestamp.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_OperationMetadataV1.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/appengine/v1/operation.proto", schemas, file_default_instances, TableStruct::offsets,
...
OperationMetadataV1::OperationMetadataV1()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fappengine_2fv1_2foperation_2eproto::scc_info_OperationMetadataV1.base);
  SharedCtor();
...
const OperationMetadataV1& OperationMetadataV1::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2foperation_2eproto::scc_info_OperationMetadataV1.base);
...
void OperationMetadataV1::SerializeWithCachedSizes(
  ...
  if (this->has_insert_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->_internal_insert_time(), output);
  }
  ...
  if (this->has_insert_time()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, this->_internal_insert_time(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::OperationMetadataV1* Arena::CreateMaybeMessage< ::google::appengine::v1::OperationMetadataV1 >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::OperationMetadataV1 >(arena);
}
}  // namespace protobuf
}  // namespace google
