...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/appengine/v1/instance.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Instance& Instance::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2finstance_2eproto::scc_info_Instance.base);
...
void Instance::InternalSwap(Instance* other) {
  ...
  app_engine_release_.Swap(&other->app_engine_release_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  vm_name_.Swap(&other->vm_name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  vm_zone_name_.Swap(&other->vm_zone_name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  vm_id_.Swap(&other->vm_id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  vm_status_.Swap(&other->vm_status_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::Instance* Arena::CreateMaybeMessage< ::google::appengine::v1::Instance >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::Instance >(arena);
}
}  // namespace protobuf
}  // namespace google
