...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fservice_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_TrafficSplit_AllocationsEntry_DoNotUse;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fservice_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_TrafficSplit;
}  // namespace protobuf_google_2fappengine_2fv1_2fservice_2eproto
namespace google {
namespace appengine {
namespace v1 {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Service =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsService}, {
      &protobuf_google_2fappengine_2fv1_2fservice_2eproto::scc_info_TrafficSplit.base,}};

static void InitDefaultsTrafficSplit_AllocationsEntry_DoNotUse() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_TrafficSplit_AllocationsEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsTrafficSplit_AllocationsEntry_DoNotUse}, {}};

static void InitDefaultsTrafficSplit() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_TrafficSplit =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsTrafficSplit}, {
      &protobuf_google_2fappengine_2fv1_2fservice_2eproto::scc_info_TrafficSplit_AllocationsEntry_DoNotUse.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Service.base);
  ::google::protobuf::internal::InitSCC(&scc_info_TrafficSplit_AllocationsEntry_DoNotUse.base);
  ::google::protobuf::internal::InitSCC(&scc_info_TrafficSplit.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/appengine/v1/service.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Service& Service::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fservice_2eproto::scc_info_Service.base);
...
const TrafficSplit& TrafficSplit::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fservice_2eproto::scc_info_TrafficSplit.base);
  return *internal_default_instance();
}
...
void TrafficSplit::SerializeWithCachedSizes(
  ...
  if (!this->allocations().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::unique_ptr<TrafficSplit_AllocationsEntry_DoNotUse> entry;
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::Service* Arena::CreateMaybeMessage< ::google::appengine::v1::Service >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::Service >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::TrafficSplit_AllocationsEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::appengine::v1::TrafficSplit_AllocationsEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::TrafficSplit_AllocationsEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::TrafficSplit* Arena::CreateMaybeMessage< ::google::appengine::v1::TrafficSplit >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::TrafficSplit >(arena);
}
}  // namespace protobuf
}  // namespace google
