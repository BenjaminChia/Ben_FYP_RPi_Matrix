...
#ifndef PROTOBUF_INCLUDED_google_2fappengine_2fv1_2foperation_2eproto
#define PROTOBUF_INCLUDED_google_2fappengine_2fv1_2foperation_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2foperation_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::appengine::v1::OperationMetadataV1* Arena::CreateMaybeMessage<::google::appengine::v1::OperationMetadataV1>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace appengine {
...
class OperationMetadataV1 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.OperationMetadataV1) */ {
 public:
  ...
  inline OperationMetadataV1* New() const final {
    return CreateMaybeMessage<OperationMetadataV1>(NULL);
  }

  OperationMetadataV1* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<OperationMetadataV1>(arena);
  }
  ...
  private:
  const ::google::protobuf::Timestamp& _internal_insert_time() const;
  public:
...
inline const ::google::protobuf::Timestamp& OperationMetadataV1::_internal_insert_time() const {
  return *insert_time_;
}
...
inline const ::google::protobuf::Timestamp& OperationMetadataV1::_internal_end_time() const {
  return *end_time_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fappengine_2fv1_2foperation_2eproto
