...
#ifndef PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fapplication_2eproto
#define PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fapplication_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fapplication_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::appengine::v1::Application* Arena::CreateMaybeMessage<::google::appengine::v1::Application>(Arena*);
template<> ::google::appengine::v1::UrlDispatchRule* Arena::CreateMaybeMessage<::google::appengine::v1::UrlDispatchRule>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace appengine {
...
class Application : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.Application) */ {
 public:
  ...
  private:
  const ::google::protobuf::Duration& _internal_default_cookie_expiration() const;
  public:
...
class UrlDispatchRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.UrlDispatchRule) */ {
 public:
  ...
  inline UrlDispatchRule* New() const final {
    return CreateMaybeMessage<UrlDispatchRule>(NULL);
  }

  UrlDispatchRule* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<UrlDispatchRule>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
inline const ::google::protobuf::Duration& Application::_internal_default_cookie_expiration() const {
...
#endif  // PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fapplication_2eproto
