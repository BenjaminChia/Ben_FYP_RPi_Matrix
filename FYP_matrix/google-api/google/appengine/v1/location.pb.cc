...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/appengine/v1/location.proto", schemas, file_default_instances, TableStruct::offsets,
...
LocationMetadata::LocationMetadata()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fappengine_2fv1_2flocation_2eproto::scc_info_LocationMetadata.base);
  SharedCtor();
...
const LocationMetadata& LocationMetadata::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2flocation_2eproto::scc_info_LocationMetadata.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::LocationMetadata* Arena::CreateMaybeMessage< ::google::appengine::v1::LocationMetadata >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::LocationMetadata >(arena);
}
}  // namespace protobuf
}  // namespace google
