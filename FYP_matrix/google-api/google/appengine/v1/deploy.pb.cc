...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fdeploy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ContainerInfo;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fdeploy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_FileInfo;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fdeploy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ZipInfo;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fdeploy_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Deployment_FilesEntry_DoNotUse;
}  // namespace protobuf_google_2fappengine_2fv1_2fdeploy_2eproto
namespace google {
namespace appengine {
namespace v1 {
...
namespace protobuf_google_2fappengine_2fv1_2fdeploy_2eproto {
static void InitDefaultsDeployment_FilesEntry_DoNotUse() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Deployment_FilesEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsDeployment_FilesEntry_DoNotUse}, {
      &protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_FileInfo.base,}};
...
::google::protobuf::internal::SCCInfo<3> scc_info_Deployment =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsDeployment}, {
      &protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_Deployment_FilesEntry_DoNotUse.base,
      &protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_ContainerInfo.base,
      &protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_ZipInfo.base,}};
...
static void InitDefaultsContainerInfo() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_ContainerInfo =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsContainerInfo}, {}};

static void InitDefaultsZipInfo() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_ZipInfo =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsZipInfo}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Deployment_FilesEntry_DoNotUse.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Deployment.base);
  ::google::protobuf::internal::InitSCC(&scc_info_FileInfo.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ContainerInfo.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ZipInfo.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/appengine/v1/deploy.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Deployment& Deployment::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_Deployment.base);
...
void Deployment::SerializeWithCachedSizes(
  ...
  if (!this->files().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::unique_ptr<Deployment_FilesEntry_DoNotUse> entry;
...
;
  ...
  if (this->has_zip()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->_internal_zip(), deterministic, target);
  }
...
const FileInfo& FileInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_FileInfo.base);
  return *internal_default_instance();
}
...
void FileInfo::InternalSwap(FileInfo* other) {
  ...
  source_url_.Swap(&other->source_url_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sha1_sum_.Swap(&other->sha1_sum_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
const ContainerInfo& ContainerInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_ContainerInfo.base);
  return *internal_default_instance();
}
...
const ZipInfo& ZipInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fappengine_2fv1_2fdeploy_2eproto::scc_info_ZipInfo.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::Deployment_FilesEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::appengine::v1::Deployment_FilesEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::Deployment_FilesEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::Deployment* Arena::CreateMaybeMessage< ::google::appengine::v1::Deployment >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::Deployment >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::FileInfo* Arena::CreateMaybeMessage< ::google::appengine::v1::FileInfo >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::FileInfo >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::ContainerInfo* Arena::CreateMaybeMessage< ::google::appengine::v1::ContainerInfo >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::ContainerInfo >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::appengine::v1::ZipInfo* Arena::CreateMaybeMessage< ::google::appengine::v1::ZipInfo >(Arena* arena) {
  return Arena::CreateInternal< ::google::appengine::v1::ZipInfo >(arena);
}
}  // namespace protobuf
}  // namespace google
