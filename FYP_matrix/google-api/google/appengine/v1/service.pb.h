...
#ifndef PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fservice_2eproto
#define PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fappengine_2fv1_2fservice_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::appengine::v1::Service* Arena::CreateMaybeMessage<::google::appengine::v1::Service>(Arena*);
template<> ::google::appengine::v1::TrafficSplit* Arena::CreateMaybeMessage<::google::appengine::v1::TrafficSplit>(Arena*);
template<> ::google::appengine::v1::TrafficSplit_AllocationsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::appengine::v1::TrafficSplit_AllocationsEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace appengine {
...
class Service : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.Service) */ {
 public:
  ...
  private:
  const ::google::appengine::v1::TrafficSplit& _internal_split() const;
  public:
...
class TrafficSplit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.TrafficSplit) */ {
 public:
  ...
  inline TrafficSplit* New() const final {
    return CreateMaybeMessage<TrafficSplit>(NULL);
  }

  TrafficSplit* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<TrafficSplit>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
inline const ::google::appengine::v1::TrafficSplit& Service::_internal_split() const {
  return *split_;
}
...
inline ::google::appengine::v1::TrafficSplit* Service::mutable_split() {
  ...
  if (split_ == NULL) {
    auto* p = CreateMaybeMessage<::google::appengine::v1::TrafficSplit>(GetArenaNoVirtual());
    split_ = p;
  }
...
template <> struct is_proto_enum< ::google::appengine::v1::TrafficSplit_ShardBy> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fappengine_2fv1_2fservice_2eproto
