...
KeyManagementService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetPublicKey_(KeyManagementService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateKeyRing_(KeyManagementService_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateCryptoKey_(KeyManagementService_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateCryptoKeyVersion_(KeyManagementService_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateCryptoKey_(KeyManagementService_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateCryptoKeyVersion_(KeyManagementService_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Encrypt_(KeyManagementService_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Decrypt_(KeyManagementService_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AsymmetricSign_(KeyManagementService_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AsymmetricDecrypt_(KeyManagementService_method_names[15], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateCryptoKeyPrimaryVersion_(KeyManagementService_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DestroyCryptoKeyVersion_(KeyManagementService_method_names[17], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RestoreCryptoKeyVersion_(KeyManagementService_method_names[18], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status KeyManagementService::Stub::GetPublicKey(::grpc::ClientContext* context, const ::google::cloud::kms::v1::GetPublicKeyRequest& request, ::google::cloud::kms::v1::PublicKey* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetPublicKey_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::PublicKey>* KeyManagementService::Stub::AsyncGetPublicKeyRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::GetPublicKeyRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::PublicKey>::Create(channel_.get(), cq, rpcmethod_GetPublicKey_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::PublicKey>* KeyManagementService::Stub::PrepareAsyncGetPublicKeyRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::GetPublicKeyRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::PublicKey>::Create(channel_.get(), cq, rpcmethod_GetPublicKey_, context, request, false);
}
...
::grpc::Status KeyManagementService::Stub::AsymmetricSign(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricSignRequest& request, ::google::cloud::kms::v1::AsymmetricSignResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AsymmetricSign_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::AsymmetricSignResponse>* KeyManagementService::Stub::AsyncAsymmetricSignRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricSignRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::AsymmetricSignResponse>::Create(channel_.get(), cq, rpcmethod_AsymmetricSign_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::AsymmetricSignResponse>* KeyManagementService::Stub::PrepareAsyncAsymmetricSignRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricSignRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::AsymmetricSignResponse>::Create(channel_.get(), cq, rpcmethod_AsymmetricSign_, context, request, false);
}

::grpc::Status KeyManagementService::Stub::AsymmetricDecrypt(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricDecryptRequest& request, ::google::cloud::kms::v1::AsymmetricDecryptResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AsymmetricDecrypt_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::AsymmetricDecryptResponse>* KeyManagementService::Stub::AsyncAsymmetricDecryptRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricDecryptRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::AsymmetricDecryptResponse>::Create(channel_.get(), cq, rpcmethod_AsymmetricDecrypt_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::kms::v1::AsymmetricDecryptResponse>* KeyManagementService::Stub::PrepareAsyncAsymmetricDecryptRaw(::grpc::ClientContext* context, const ::google::cloud::kms::v1::AsymmetricDecryptRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::kms::v1::AsymmetricDecryptResponse>::Create(channel_.get(), cq, rpcmethod_AsymmetricDecrypt_, context, request, false);
}
...
KeyManagementService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KeyManagementService::Service, ::google::cloud::kms::v1::GetPublicKeyRequest, ::google::cloud::kms::v1::PublicKey>(
          std::mem_fn(&KeyManagementService::Service::GetPublicKey), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KeyManagementService::Service, ::google::cloud::kms::v1::AsymmetricSignRequest, ::google::cloud::kms::v1::AsymmetricSignResponse>(
          std::mem_fn(&KeyManagementService::Service::AsymmetricSign), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KeyManagementService_method_names[15],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KeyManagementService::Service, ::google::cloud::kms::v1::AsymmetricDecryptRequest, ::google::cloud::kms::v1::AsymmetricDecryptResponse>(
          std::mem_fn(&KeyManagementService::Service::AsymmetricDecrypt), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KeyManagementService_method_names[16],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KeyManagementService_method_names[17],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KeyManagementService_method_names[18],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
...
::grpc::Status KeyManagementService::Service::GetPublicKey(::grpc::ServerContext* context, const ::google::cloud::kms::v1::GetPublicKeyRequest* request, ::google::cloud::kms::v1::PublicKey* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status KeyManagementService::Service::AsymmetricSign(::grpc::ServerContext* context, const ::google::cloud::kms::v1::AsymmetricSignRequest* request, ::google::cloud::kms::v1::AsymmetricSignResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status KeyManagementService::Service::AsymmetricDecrypt(::grpc::ServerContext* context, const ::google::cloud::kms::v1::AsymmetricDecryptRequest* request, ::google::cloud::kms::v1::AsymmetricDecryptResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
