...
::grpc::Status ImageAnnotator::Stub::AsyncBatchAnnotateFiles(::grpc::ClientContext* context, const ::google::cloud::vision::v1::AsyncBatchAnnotateFilesRequest& request, ::google::longrunning::Operation* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AsyncBatchAnnotateFiles_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* ImageAnnotator::Stub::AsyncAsyncBatchAnnotateFilesRaw(::grpc::ClientContext* context, const ::google::cloud::vision::v1::AsyncBatchAnnotateFilesRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* ImageAnnotator::Stub::PrepareAsyncAsyncBatchAnnotateFilesRaw(::grpc::ClientContext* context, const ::google::cloud::vision::v1::AsyncBatchAnnotateFilesRequest& request, ::grpc::CompletionQueue* cq) {
...
ImageAnnotator::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ImageAnnotator::Service, ::google::cloud::vision::v1::AsyncBatchAnnotateFilesRequest, ::google::longrunning::Operation>(
...
::grpc::Status ImageAnnotator::Service::AsyncBatchAnnotateFiles(::grpc::ServerContext* context, const ::google::cloud::vision::v1::AsyncBatchAnnotateFilesRequest* request, ::google::longrunning::Operation* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
