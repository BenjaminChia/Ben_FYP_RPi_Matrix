   ...
   public:
    WithStreamedUnaryMethod_ListVoices() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::texttospeech::v1::ListVoicesRequest, ::google::cloud::texttospeech::v1::ListVoicesResponse>(std::bind(&WithStreamedUnaryMethod_ListVoices<BaseClass>::StreamedListVoices, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_SynthesizeSpeech() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::texttospeech::v1::SynthesizeSpeechRequest, ::google::cloud::texttospeech::v1::SynthesizeSpeechResponse>(std::bind(&WithStreamedUnaryMethod_SynthesizeSpeech<BaseClass>::StreamedSynthesizeSpeech, this, std::placeholders::_1, std::placeholders::_2)));
    }
