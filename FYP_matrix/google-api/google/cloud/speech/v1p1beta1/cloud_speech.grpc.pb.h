 ...
 public:
  ...
  class WithAsyncMethod_Recognize : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status Recognize(::grpc::ServerContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_LongRunningRecognize : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status LongRunningRecognize(::grpc::ServerContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_StreamingRecognize : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status StreamingRecognize(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::google::cloud::speech::v1p1beta1::StreamingRecognizeResponse, ::google::cloud::speech::v1p1beta1::StreamingRecognizeRequest>* stream)  override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
