   ...
   public:
    WithStreamedUnaryMethod_DetectIntent() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::DetectIntentRequest, ::google::cloud::dialogflow::v2::DetectIntentResponse>(std::bind(&WithStreamedUnaryMethod_DetectIntent<BaseClass>::StreamedDetectIntent, this, std::placeholders::_1, std::placeholders::_2)));
    }
