   ...
   public:
    WithStreamedUnaryMethod_ListSessionEntityTypes() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::ListSessionEntityTypesRequest, ::google::cloud::dialogflow::v2::ListSessionEntityTypesResponse>(std::bind(&WithStreamedUnaryMethod_ListSessionEntityTypes<BaseClass>::StreamedListSessionEntityTypes, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetSessionEntityType() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::GetSessionEntityTypeRequest, ::google::cloud::dialogflow::v2::SessionEntityType>(std::bind(&WithStreamedUnaryMethod_GetSessionEntityType<BaseClass>::StreamedGetSessionEntityType, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_CreateSessionEntityType() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::CreateSessionEntityTypeRequest, ::google::cloud::dialogflow::v2::SessionEntityType>(std::bind(&WithStreamedUnaryMethod_CreateSessionEntityType<BaseClass>::StreamedCreateSessionEntityType, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_UpdateSessionEntityType() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::UpdateSessionEntityTypeRequest, ::google::cloud::dialogflow::v2::SessionEntityType>(std::bind(&WithStreamedUnaryMethod_UpdateSessionEntityType<BaseClass>::StreamedUpdateSessionEntityType, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_DeleteSessionEntityType() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::dialogflow::v2::DeleteSessionEntityTypeRequest, ::google::protobuf::Empty>(std::bind(&WithStreamedUnaryMethod_DeleteSessionEntityType<BaseClass>::StreamedDeleteSessionEntityType, this, std::placeholders::_1, std::placeholders::_2)));
    }
