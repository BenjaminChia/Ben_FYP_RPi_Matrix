 ...
 public:
  ...
  class WithAsyncMethod_DetectIntent : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status DetectIntent(::grpc::ServerContext* context, const ::google::cloud::dialogflow::v2beta1::DetectIntentRequest* request, ::google::cloud::dialogflow::v2beta1::DetectIntentResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_StreamingDetectIntent : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status StreamingDetectIntent(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::google::cloud::dialogflow::v2beta1::StreamingDetectIntentResponse, ::google::cloud::dialogflow::v2beta1::StreamingDetectIntentRequest>* stream)  override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
