...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::WebhookRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::WebhookRequest>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::WebhookResponse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::WebhookResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class WebhookRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.WebhookRequest) */ {
 public:
  ...
  inline WebhookRequest* New() const final {
    return CreateMaybeMessage<WebhookRequest>(NULL);
  }
  ...
  private:
  const ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest& _internal_original_detect_intent_request() const;
  public:
...
class WebhookResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.WebhookResponse) */ {
 public:
  ...
  inline WebhookResponse* New() const final {
    return CreateMaybeMessage<WebhookResponse>(NULL);
  }
  ...
  private:
  const ::google::cloud::dialogflow::v2beta1::EventInput& _internal_followup_event_input() const;
  public:
  ...
  static const int kEndInteractionFieldNumber = 8;
...
class OriginalDetectIntentRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest) */ {
 public:
  ...
  inline OriginalDetectIntentRequest* New() const final {
    return CreateMaybeMessage<OriginalDetectIntentRequest>(NULL);
  }

  OriginalDetectIntentRequest* New(::google::protobuf::Arena* arena) const final {
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& WebhookRequest::_internal_query_result() const {
...
// repeated .google.cloud.dialogflow.v2beta1.QueryResult alternative_query_results = 5;
inline int WebhookRequest::alternative_query_results_size() const {
  return alternative_query_results_.size();
}
inline ::google::cloud::dialogflow::v2beta1::QueryResult* WebhookRequest::mutable_alternative_query_results(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.WebhookRequest.alternative_query_results)
...
WebhookRequest::mutable_alternative_query_results() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.WebhookRequest.alternative_query_results)
  return &alternative_query_results_;
}
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& WebhookRequest::alternative_query_results(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.WebhookRequest.alternative_query_results)
  return alternative_query_results_.Get(index);
}
inline ::google::cloud::dialogflow::v2beta1::QueryResult* WebhookRequest::add_alternative_query_results() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.WebhookRequest.alternative_query_results)
...
WebhookRequest::alternative_query_results() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.WebhookRequest.alternative_query_results)
  return alternative_query_results_;
}
...
inline const ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest& WebhookRequest::_internal_original_detect_intent_request() const {
...
inline ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest* WebhookRequest::mutable_original_detect_intent_request() {
  ...
  if (original_detect_intent_request_ == NULL) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest>(GetArenaNoVirtual());
...
inline const ::google::protobuf::Struct& WebhookResponse::_internal_payload() const {
  return *payload_;
}
...
inline const ::google::cloud::dialogflow::v2beta1::EventInput& WebhookResponse::_internal_followup_event_input() const {
...
inline ::google::cloud::dialogflow::v2beta1::EventInput* WebhookResponse::mutable_followup_event_input() {
  ...
  if (followup_event_input_ == NULL) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::EventInput>(GetArenaNoVirtual());
...
// bool end_interaction = 8;
inline void WebhookResponse::clear_end_interaction() {
  end_interaction_ = false;
}
inline bool WebhookResponse::end_interaction() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.WebhookResponse.end_interaction)
  return end_interaction_;
}
inline void WebhookResponse::set_end_interaction(bool value) {
  
  end_interaction_ = value;
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.WebhookResponse.end_interaction)
}
...
inline const ::std::string& OriginalDetectIntentRequest::version() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
  return version_.Get();
}
inline void OriginalDetectIntentRequest::set_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
#if LANG_CXX11
inline void OriginalDetectIntentRequest::set_version(::std::string&& value) {
  ...
  version_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
#endif
inline void OriginalDetectIntentRequest::set_version(const char* value) {
  ...
  version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
inline void OriginalDetectIntentRequest::set_version(const char* value,
    size_t size) {
  ...
  version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
inline ::std::string* OriginalDetectIntentRequest::mutable_version() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
...
inline ::std::string* OriginalDetectIntentRequest::release_version() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
...
inline void OriginalDetectIntentRequest::set_allocated_version(::std::string* version) {
  ...
  version_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), version,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
inline ::std::string* OriginalDetectIntentRequest::unsafe_arena_release_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  
  return version_.UnsafeArenaRelease(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void OriginalDetectIntentRequest::unsafe_arena_set_allocated_version(
    ::std::string* version) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (version != NULL) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest.version)
}
...
inline const ::google::protobuf::Struct& OriginalDetectIntentRequest::_internal_payload() const {
  return *payload_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
