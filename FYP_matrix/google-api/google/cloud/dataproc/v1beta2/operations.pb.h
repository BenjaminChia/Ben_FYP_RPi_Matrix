...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::dataproc::v1beta2::ClusterOperationMetadata* Arena::CreateMaybeMessage<::google::cloud::dataproc::v1beta2::ClusterOperationMetadata>(Arena*);
template<> ::google::cloud::dataproc::v1beta2::ClusterOperationMetadata_LabelsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::cloud::dataproc::v1beta2::ClusterOperationMetadata_LabelsEntry_DoNotUse>(Arena*);
template<> ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* Arena::CreateMaybeMessage<::google::cloud::dataproc::v1beta2::ClusterOperationStatus>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class ClusterOperationStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.dataproc.v1beta2.ClusterOperationStatus) */ {
 public:
  ...
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State state() const;
  void set_state(::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State value);
 ...
 private:
  ...
  friend struct ::protobuf_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class ClusterOperationMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.dataproc.v1beta2.ClusterOperationMetadata) */ {
 public:
  ...
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* mutable_status_history(int index);
  ::google::protobuf::RepeatedPtrField< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus >*
      mutable_status_history();
  const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& status_history(int index) const;
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* add_status_history();
  const ::google::protobuf::RepeatedPtrField< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus >&
  ...
  private:
  const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& _internal_status() const;
  public:
  const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& status() const;
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* release_status();
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* mutable_status();
  void set_allocated_status(::google::cloud::dataproc::v1beta2::ClusterOperationStatus* status);

  // @@protoc_insertion_point(class_scope:google.cloud.dataproc.v1beta2.ClusterOperationMetadata)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus > status_history_;
  ...
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* status_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State ClusterOperationStatus::state() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state)
  return static_cast< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State >(state_);
}
inline void ClusterOperationStatus::set_state(::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State value) {
  
  state_ = value;
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state)
}
...
inline const ::std::string& ClusterOperationStatus::inner_state() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
...
inline void ClusterOperationStatus::set_inner_state(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
}
#if LANG_CXX11
inline void ClusterOperationStatus::set_inner_state(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
}
#endif
inline void ClusterOperationStatus::set_inner_state(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
}
inline void ClusterOperationStatus::set_inner_state(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
}
inline ::std::string* ClusterOperationStatus::mutable_inner_state() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
...
inline ::std::string* ClusterOperationStatus::release_inner_state() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
...
inline void ClusterOperationStatus::set_allocated_inner_state(::std::string* inner_state) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state)
}
...
inline const ::std::string& ClusterOperationStatus::details() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
...
inline void ClusterOperationStatus::set_details(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
}
#if LANG_CXX11
inline void ClusterOperationStatus::set_details(::std::string&& value) {
  ...
  details_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
}
#endif
inline void ClusterOperationStatus::set_details(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
}
inline void ClusterOperationStatus::set_details(const char* value, size_t size) {
  ...
  details_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
}
inline ::std::string* ClusterOperationStatus::mutable_details() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
...
inline ::std::string* ClusterOperationStatus::release_details() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
...
inline void ClusterOperationStatus::set_allocated_details(::std::string* details) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationStatus.details)
}
...
inline const ::google::protobuf::Timestamp& ClusterOperationStatus::state_start_time() const {
  ...
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state_start_time)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* ClusterOperationStatus::release_state_start_time() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state_start_time)
...
inline ::google::protobuf::Timestamp* ClusterOperationStatus::mutable_state_start_time() {
  ...
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state_start_time)
  return state_start_time_;
}
inline void ClusterOperationStatus::set_allocated_state_start_time(::google::protobuf::Timestamp* state_start_time) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationStatus.state_start_time)
}
...
inline const ::std::string& ClusterOperationMetadata::cluster_name() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
...
inline void ClusterOperationMetadata::set_cluster_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
}
#if LANG_CXX11
inline void ClusterOperationMetadata::set_cluster_name(::std::string&& value) {
  ...
  cluster_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
}
#endif
inline void ClusterOperationMetadata::set_cluster_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
}
inline void ClusterOperationMetadata::set_cluster_name(const char* value, size_t size) {
  ...
  cluster_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
}
inline ::std::string* ClusterOperationMetadata::mutable_cluster_name() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
...
inline ::std::string* ClusterOperationMetadata::release_cluster_name() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
...
inline void ClusterOperationMetadata::set_allocated_cluster_name(::std::string* cluster_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name)
}
...
inline const ::std::string& ClusterOperationMetadata::cluster_uuid() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
...
inline void ClusterOperationMetadata::set_cluster_uuid(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
}
#if LANG_CXX11
inline void ClusterOperationMetadata::set_cluster_uuid(::std::string&& value) {
  ...
  cluster_uuid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
}
#endif
inline void ClusterOperationMetadata::set_cluster_uuid(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
}
inline void ClusterOperationMetadata::set_cluster_uuid(const char* value, size_t size) {
  ...
  cluster_uuid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
}
inline ::std::string* ClusterOperationMetadata::mutable_cluster_uuid() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
...
inline ::std::string* ClusterOperationMetadata::release_cluster_uuid() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
...
inline void ClusterOperationMetadata::set_allocated_cluster_uuid(::std::string* cluster_uuid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid)
}
...
inline const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& ClusterOperationMetadata::_internal_status() const {
  return *status_;
}
inline const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& ClusterOperationMetadata::status() const {
  const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* p = status_;
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status)
  return p != NULL ? *p : *reinterpret_cast<const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus*>(
      &::google::cloud::dataproc::v1beta2::_ClusterOperationStatus_default_instance_);
}
inline ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* ClusterOperationMetadata::release_status() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status)
  
  ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* temp = status_;
  status_ = NULL;
  return temp;
}
inline ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* ClusterOperationMetadata::mutable_status() {
  
  if (status_ == NULL) {
    auto* p = CreateMaybeMessage<::google::cloud::dataproc::v1beta2::ClusterOperationStatus>(GetArenaNoVirtual());
    status_ = p;
  }
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status)
  return status_;
}
inline void ClusterOperationMetadata::set_allocated_status(::google::cloud::dataproc::v1beta2::ClusterOperationStatus* status) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete status_;
  }
  ...
  status_ = status;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status)
}
...
inline ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* ClusterOperationMetadata::mutable_status_history(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history)
  return status_history_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus >*
ClusterOperationMetadata::mutable_status_history() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history)
  return &status_history_;
}
inline const ::google::cloud::dataproc::v1beta2::ClusterOperationStatus& ClusterOperationMetadata::status_history(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history)
  return status_history_.Get(index);
}
inline ::google::cloud::dataproc::v1beta2::ClusterOperationStatus* ClusterOperationMetadata::add_status_history() {
  // @@protoc_insertion_point(field_add:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history)
  return status_history_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus >&
ClusterOperationMetadata::status_history() const {
  // @@protoc_insertion_point(field_list:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history)
  return status_history_;
}
...
inline const ::std::string& ClusterOperationMetadata::operation_type() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
...
inline void ClusterOperationMetadata::set_operation_type(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
}
#if LANG_CXX11
inline void ClusterOperationMetadata::set_operation_type(::std::string&& value) {
  ...
  operation_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
}
#endif
inline void ClusterOperationMetadata::set_operation_type(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
}
inline void ClusterOperationMetadata::set_operation_type(const char* value, size_t size) {
  ...
  operation_type_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
}
inline ::std::string* ClusterOperationMetadata::mutable_operation_type() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
...
inline ::std::string* ClusterOperationMetadata::release_operation_type() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
...
inline void ClusterOperationMetadata::set_allocated_operation_type(::std::string* operation_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type)
}
...
inline const ::std::string& ClusterOperationMetadata::description() const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
  return description_.GetNoArena();
}
inline void ClusterOperationMetadata::set_description(const ::std::string& value) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
}
#if LANG_CXX11
inline void ClusterOperationMetadata::set_description(::std::string&& value) {
  ...
  description_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
}
#endif
inline void ClusterOperationMetadata::set_description(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
}
inline void ClusterOperationMetadata::set_description(const char* value, size_t size) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
}
inline ::std::string* ClusterOperationMetadata::mutable_description() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
  return description_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ClusterOperationMetadata::release_description() {
  // @@protoc_insertion_point(field_release:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
...
inline void ClusterOperationMetadata::set_allocated_description(::std::string* description) {
  ...
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description)
}
...
ClusterOperationMetadata::labels() const {
  // @@protoc_insertion_point(field_map:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.labels)
  return labels_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
ClusterOperationMetadata::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_map:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.labels)
...
inline const ::std::string& ClusterOperationMetadata::warnings(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
  return warnings_.Get(index);
}
inline ::std::string* ClusterOperationMetadata::mutable_warnings(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
  return warnings_.Mutable(index);
}
inline void ClusterOperationMetadata::set_warnings(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
...
inline void ClusterOperationMetadata::set_warnings(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  warnings_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
}
inline void ClusterOperationMetadata::set_warnings(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
}
inline ::std::string* ClusterOperationMetadata::add_warnings() {
  // @@protoc_insertion_point(field_add_mutable:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
  return warnings_.Add();
}
inline void ClusterOperationMetadata::add_warnings(const ::std::string& value) {
  warnings_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
}
#if LANG_CXX11
...
inline void ClusterOperationMetadata::add_warnings(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  warnings_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
}
inline void ClusterOperationMetadata::add_warnings(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ClusterOperationMetadata::warnings() const {
  // @@protoc_insertion_point(field_list:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
  return warnings_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ClusterOperationMetadata::mutable_warnings() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings)
  return &warnings_;
}
...
template <> struct is_proto_enum< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State>() {
  return ::google::cloud::dataproc::v1beta2::ClusterOperationStatus_State_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2fdataproc_2fv1beta2_2foperations_2eproto
