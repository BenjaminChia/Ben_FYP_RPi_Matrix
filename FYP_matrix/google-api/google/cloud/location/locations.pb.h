...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2flocation_2flocations_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2flocation_2flocations_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2flocation_2flocations_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::location::GetLocationRequest* Arena::CreateMaybeMessage<::google::cloud::location::GetLocationRequest>(Arena*);
template<> ::google::cloud::location::ListLocationsRequest* Arena::CreateMaybeMessage<::google::cloud::location::ListLocationsRequest>(Arena*);
template<> ::google::cloud::location::ListLocationsResponse* Arena::CreateMaybeMessage<::google::cloud::location::ListLocationsResponse>(Arena*);
template<> ::google::cloud::location::Location* Arena::CreateMaybeMessage<::google::cloud::location::Location>(Arena*);
template<> ::google::cloud::location::Location_LabelsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::cloud::location::Location_LabelsEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class ListLocationsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.location.ListLocationsRequest) */ {
 public:
  ...
  inline ListLocationsRequest* New() const final {
    return CreateMaybeMessage<ListLocationsRequest>(NULL);
  }

  ListLocationsRequest* New(::google::protobuf::Arena* arena) const final {
...
class ListLocationsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.location.ListLocationsResponse) */ {
 public:
  ...
  inline ListLocationsResponse* New() const final {
    return CreateMaybeMessage<ListLocationsResponse>(NULL);
  }

  ListLocationsResponse* New(::google::protobuf::Arena* arena) const final {
...
class GetLocationRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.location.GetLocationRequest) */ {
 public:
  ...
  inline GetLocationRequest* New() const final {
    return CreateMaybeMessage<GetLocationRequest>(NULL);
  }

  GetLocationRequest* New(::google::protobuf::Arena* arena) const final {
...
// string display_name = 5;
inline void Location::clear_display_name() {
  display_name_.ClearToEmpty(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline const ::std::string& Location::display_name() const {
  // @@protoc_insertion_point(field_get:google.cloud.location.Location.display_name)
  return display_name_.Get();
}
inline void Location::set_display_name(const ::std::string& value) {
  
  display_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:google.cloud.location.Location.display_name)
}
#if LANG_CXX11
inline void Location::set_display_name(::std::string&& value) {
  
  display_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.location.Location.display_name)
}
#endif
inline void Location::set_display_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  display_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:google.cloud.location.Location.display_name)
}
inline void Location::set_display_name(const char* value,
    size_t size) {
  ...
  display_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.location.Location.display_name)
}
inline ::std::string* Location::mutable_display_name() {
  
  // @@protoc_insertion_point(field_mutable:google.cloud.location.Location.display_name)
  return display_name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Location::release_display_name() {
  // @@protoc_insertion_point(field_release:google.cloud.location.Location.display_name)
  
  return display_name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void Location::set_allocated_display_name(::std::string* display_name) {
  ...
  display_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), display_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.location.Location.display_name)
}
inline ::std::string* Location::unsafe_arena_release_display_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.location.Location.display_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  
  return display_name_.UnsafeArenaRelease(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void Location::unsafe_arena_set_allocated_display_name(
    ::std::string* display_name) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (display_name != NULL) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.location.Location.display_name)
}
...
inline const ::google::protobuf::Any& Location::_internal_metadata() const {
  return *metadata_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2flocation_2flocations_2eproto
