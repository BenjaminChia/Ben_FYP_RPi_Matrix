...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2fruntimeconfig_2fv1beta1_2fresources_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2fruntimeconfig_2fv1beta1_2fresources_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fruntimeconfig_2fv1beta1_2fresources_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::runtimeconfig::v1beta1::EndCondition* Arena::CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::EndCondition>(Arena*);
template<> ::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality* Arena::CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality>(Arena*);
template<> ::google::cloud::runtimeconfig::v1beta1::RuntimeConfig* Arena::CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::RuntimeConfig>(Arena*);
template<> ::google::cloud::runtimeconfig::v1beta1::Variable* Arena::CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::Variable>(Arena*);
template<> ::google::cloud::runtimeconfig::v1beta1::Waiter* Arena::CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::Waiter>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class RuntimeConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.runtimeconfig.v1beta1.RuntimeConfig) */ {
 public:
  ...
  inline RuntimeConfig* New() const final {
    return CreateMaybeMessage<RuntimeConfig>(NULL);
  }

  RuntimeConfig* New(::google::protobuf::Arena* arena) const final {
...
class EndCondition_Cardinality : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.runtimeconfig.v1beta1.EndCondition.Cardinality) */ {
 public:
  ...
  inline EndCondition_Cardinality* New() const final {
    return CreateMaybeMessage<EndCondition_Cardinality>(NULL);
  }

  EndCondition_Cardinality* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<EndCondition_Cardinality>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class EndCondition : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.runtimeconfig.v1beta1.EndCondition) */ {
 public:
  ...
  inline EndCondition* New() const final {
    return CreateMaybeMessage<EndCondition>(NULL);
  }

  EndCondition* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<EndCondition>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  ...
  private:
  const ::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality& _internal_cardinality() const;
  public:
...
class Waiter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.runtimeconfig.v1beta1.Waiter) */ {
 public:
  ...
  inline Waiter* New() const final {
    return CreateMaybeMessage<Waiter>(NULL);
  }

  Waiter* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<Waiter>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  ...
  private:
  const ::google::cloud::runtimeconfig::v1beta1::EndCondition& _internal_failure() const;
  public:
  ...
  private:
  const ::google::cloud::runtimeconfig::v1beta1::EndCondition& _internal_success() const;
  public:
...
inline void Variable::set_value(::std::string&& value) {
  ...
  contents_.value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Variable::set_allocated_value(::std::string* value) {
  ...
  if (value != NULL) {
    set_has_value();
    contents_.value_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  }
...
inline void Variable::set_text(::std::string&& value) {
  ...
  contents_.text_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Variable::set_allocated_text(::std::string* text) {
  ...
  if (text != NULL) {
    set_has_text();
    contents_.text_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), text);
  }
...
inline const ::google::protobuf::Timestamp& Variable::_internal_update_time() const {
  return *update_time_;
}
...
inline const ::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality& EndCondition::_internal_cardinality() const {
...
inline ::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality* EndCondition::mutable_cardinality() {
  if (!has_cardinality()) {
    clear_condition();
    set_has_cardinality();
    condition_.cardinality_ = CreateMaybeMessage< ::google::cloud::runtimeconfig::v1beta1::EndCondition_Cardinality >(
        GetArenaNoVirtual());
  }
...
inline const ::google::protobuf::Duration& Waiter::_internal_timeout() const {
  return *timeout_;
}
...
inline const ::google::cloud::runtimeconfig::v1beta1::EndCondition& Waiter::_internal_failure() const {
  return *failure_;
}
...
inline ::google::cloud::runtimeconfig::v1beta1::EndCondition* Waiter::mutable_failure() {
  ...
  if (failure_ == NULL) {
    auto* p = CreateMaybeMessage<::google::cloud::runtimeconfig::v1beta1::EndCondition>(GetArenaNoVirtual());
    failure_ = p;
  }
...
inline const ::google::cloud::runtimeconfig::v1beta1::EndCondition& Waiter::_internal_success() const {
  return *success_;
}
...
inline const ::google::protobuf::Timestamp& Waiter::_internal_create_time() const {
  return *create_time_;
}
...
inline const ::google::rpc::Status& Waiter::_internal_error() const {
  return *error_;
}
...
template <> struct is_proto_enum< ::google::cloud::runtimeconfig::v1beta1::VariableState> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2fruntimeconfig_2fv1beta1_2fresources_2eproto
