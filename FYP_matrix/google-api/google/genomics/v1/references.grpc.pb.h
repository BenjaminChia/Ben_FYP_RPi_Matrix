 ...
 public:
  ...
  class WithAsyncMethod_SearchReferenceSets : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status SearchReferenceSets(::grpc::ServerContext* context, const ::google::genomics::v1::SearchReferenceSetsRequest* request, ::google::genomics::v1::SearchReferenceSetsResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_GetReferenceSet : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetReferenceSet(::grpc::ServerContext* context, const ::google::genomics::v1::GetReferenceSetRequest* request, ::google::genomics::v1::ReferenceSet* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_SearchReferences : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status SearchReferences(::grpc::ServerContext* context, const ::google::genomics::v1::SearchReferencesRequest* request, ::google::genomics::v1::SearchReferencesResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_GetReference : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetReference(::grpc::ServerContext* context, const ::google::genomics::v1::GetReferenceRequest* request, ::google::genomics::v1::Reference* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_ListBases : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ListBases(::grpc::ServerContext* context, const ::google::genomics::v1::ListBasesRequest* request, ::google::genomics::v1::ListBasesResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_SearchReferenceSets : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_SearchReferenceSets() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_SearchReferenceSets() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SearchReferenceSets(::grpc::ServerContext* context, const ::google::genomics::v1::SearchReferenceSetsRequest* request, ::google::genomics::v1::SearchReferenceSetsResponse* response) override {
    ...
    void RequestSearchReferenceSets(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_GetReferenceSet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_GetReferenceSet() {
      ::grpc::Service::MarkMethodRaw(1);
    }
    ~WithRawMethod_GetReferenceSet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetReferenceSet(::grpc::ServerContext* context, const ::google::genomics::v1::GetReferenceSetRequest* request, ::google::genomics::v1::ReferenceSet* response) override {
    ...
    void RequestGetReferenceSet(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_SearchReferences : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_SearchReferences() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_SearchReferences() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SearchReferences(::grpc::ServerContext* context, const ::google::genomics::v1::SearchReferencesRequest* request, ::google::genomics::v1::SearchReferencesResponse* response) override {
    ...
    void RequestSearchReferences(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_GetReference : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_GetReference() {
      ::grpc::Service::MarkMethodRaw(3);
    }
    ~WithRawMethod_GetReference() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetReference(::grpc::ServerContext* context, const ::google::genomics::v1::GetReferenceRequest* request, ::google::genomics::v1::Reference* response) override {
    ...
    void RequestGetReference(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_ListBases : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListBases() {
      ::grpc::Service::MarkMethodRaw(4);
    }
    ~WithRawMethod_ListBases() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListBases(::grpc::ServerContext* context, const ::google::genomics::v1::ListBasesRequest* request, ::google::genomics::v1::ListBasesResponse* response) override {
    ...
    void RequestListBases(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(4, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
