...
static void InitDefaultsCigarUnit() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_CigarUnit =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsCigarUnit}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_CigarUnit.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/cigar.proto", schemas, file_default_instances, TableStruct::offsets,
...
CigarUnit::CigarUnit(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2fcigar_2eproto::scc_info_CigarUnit.base);
  SharedCtor();
...
void CigarUnit::InternalSwap(CigarUnit* other) {
  using std::swap;
  reference_sequence_.Swap(&other->reference_sequence_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::CigarUnit* Arena::CreateMaybeMessage< ::google::genomics::v1::CigarUnit >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::CigarUnit >(arena);
}
}  // namespace protobuf
}  // namespace google
