...
#ifndef PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadalignment_2eproto
#define PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadalignment_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::genomics::v1::LinearAlignment* Arena::CreateMaybeMessage<::google::genomics::v1::LinearAlignment>(Arena*);
template<> ::google::genomics::v1::Read* Arena::CreateMaybeMessage<::google::genomics::v1::Read>(Arena*);
template<> ::google::genomics::v1::Read_InfoEntry_DoNotUse* Arena::CreateMaybeMessage<::google::genomics::v1::Read_InfoEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace genomics {
...
class LinearAlignment : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.LinearAlignment) */ {
 public:
  ...
  private:
  const ::google::genomics::v1::Position& _internal_position() const;
  public:
...
class Read : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.Read) */ {
 public:
  ...
  private:
  const ::google::genomics::v1::LinearAlignment& _internal_alignment() const;
  public:
  ...
  private:
  const ::google::genomics::v1::Position& _internal_next_mate_position() const;
  public:
...
inline const ::google::genomics::v1::Position& LinearAlignment::_internal_position() const {
  return *position_;
}
...
inline ::google::genomics::v1::Position* LinearAlignment::mutable_position() {
  ...
  if (position_ == NULL) {
    auto* p = CreateMaybeMessage<::google::genomics::v1::Position>(GetArenaNoVirtual());
    position_ = p;
  }
...
inline const ::google::genomics::v1::LinearAlignment& Read::_internal_alignment() const {
  return *alignment_;
}
...
inline ::google::genomics::v1::LinearAlignment* Read::mutable_alignment() {
  ...
  if (alignment_ == NULL) {
    auto* p = CreateMaybeMessage<::google::genomics::v1::LinearAlignment>(GetArenaNoVirtual());
    alignment_ = p;
  }
...
inline const ::google::genomics::v1::Position& Read::_internal_next_mate_position() const {
...
#endif  // PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadalignment_2eproto
