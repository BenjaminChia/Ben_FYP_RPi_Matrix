...
#ifndef PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroup_2eproto
#define PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroup_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::genomics::v1::ReadGroup* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroup>(Arena*);
template<> ::google::genomics::v1::ReadGroup_Experiment* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroup_Experiment>(Arena*);
template<> ::google::genomics::v1::ReadGroup_InfoEntry_DoNotUse* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroup_InfoEntry_DoNotUse>(Arena*);
template<> ::google::genomics::v1::ReadGroup_Program* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroup_Program>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace genomics {
...
class ReadGroup_Experiment : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.ReadGroup.Experiment) */ {
 public:
  ...
  inline ReadGroup_Experiment* New() const final {
    return CreateMaybeMessage<ReadGroup_Experiment>(NULL);
  }

  ReadGroup_Experiment* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ReadGroup_Experiment>(arena);
  }
...
class ReadGroup_Program : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.ReadGroup.Program) */ {
 public:
  ...
  inline ReadGroup_Program* New() const final {
    return CreateMaybeMessage<ReadGroup_Program>(NULL);
  }

  ReadGroup_Program* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ReadGroup_Program>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ReadGroup : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.ReadGroup) */ {
 public:
  ...
  private:
  const ::google::genomics::v1::ReadGroup_Experiment& _internal_experiment() const;
  public:
...
inline const ::google::genomics::v1::ReadGroup_Experiment& ReadGroup::_internal_experiment() const {
  return *experiment_;
}
...
inline ::google::genomics::v1::ReadGroup_Experiment* ReadGroup::mutable_experiment() {
  ...
  if (experiment_ == NULL) {
    auto* p = CreateMaybeMessage<::google::genomics::v1::ReadGroup_Experiment>(GetArenaNoVirtual());
    experiment_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroup_2eproto
