...
#ifndef PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroupset_2eproto
#define PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroupset_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::genomics::v1::ReadGroupSet* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroupSet>(Arena*);
template<> ::google::genomics::v1::ReadGroupSet_InfoEntry_DoNotUse* Arena::CreateMaybeMessage<::google::genomics::v1::ReadGroupSet_InfoEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace genomics {
...
class ReadGroupSet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.ReadGroupSet) */ {
 public:
  ...
  inline ReadGroupSet* New() const final {
    return CreateMaybeMessage<ReadGroupSet>(NULL);
  }

  ReadGroupSet* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ReadGroupSet>(arena);
  }
...
#endif  // PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2freadgroupset_2eproto
