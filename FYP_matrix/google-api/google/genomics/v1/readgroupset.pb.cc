...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto ::google::protobuf::internal::SCCInfo<3> scc_info_ReadGroup;
}  // namespace protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto
namespace protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ReadGroupSet_InfoEntry_DoNotUse;
}  // namespace protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto
...
namespace protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto {
static void InitDefaultsReadGroupSet_InfoEntry_DoNotUse() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_ReadGroupSet_InfoEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsReadGroupSet_InfoEntry_DoNotUse}, {
      &protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base,}};

static void InitDefaultsReadGroupSet() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_ReadGroupSet =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsReadGroupSet}, {
      &protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup.base,
      &protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::scc_info_ReadGroupSet_InfoEntry_DoNotUse.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroupSet_InfoEntry_DoNotUse.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroupSet.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/readgroupset.proto", schemas, file_default_instances, TableStruct::offsets,
...
ReadGroupSet::ReadGroupSet(::google::protobuf::Arena* arena)
  ...
  read_groups_(arena),
  info_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadgroupset_2eproto::scc_info_ReadGroupSet.base);
  SharedCtor();
...
void ReadGroupSet::SerializeWithCachedSizes(
  ...
  if (!this->info().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::unique_ptr<ReadGroupSet_InfoEntry_DoNotUse> entry;
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroupSet_InfoEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroupSet_InfoEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroupSet_InfoEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroupSet* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroupSet >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroupSet >(arena);
}
}  // namespace protobuf
}  // namespace google
