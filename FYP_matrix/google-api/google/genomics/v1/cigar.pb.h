...
#ifndef PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2fcigar_2eproto
#define PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2fcigar_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2fcigar_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::genomics::v1::CigarUnit* Arena::CreateMaybeMessage<::google::genomics::v1::CigarUnit>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace genomics {
...
class CigarUnit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.genomics.v1.CigarUnit) */ {
 public:
  ...
  inline CigarUnit* New() const final {
    return CreateMaybeMessage<CigarUnit>(NULL);
  }

  CigarUnit* New(::google::protobuf::Arena* arena) const final {
...
template <> struct is_proto_enum< ::google::genomics::v1::CigarUnit_Operation> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fgenomics_2fv1_2fcigar_2eproto
