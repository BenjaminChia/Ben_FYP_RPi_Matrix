...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/range.proto", schemas, file_default_instances, TableStruct::offsets,
...
Range::Range(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2frange_2eproto::scc_info_Range.base);
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::Range* Arena::CreateMaybeMessage< ::google::genomics::v1::Range >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::Range >(arena);
}
}  // namespace protobuf
}  // namespace google
