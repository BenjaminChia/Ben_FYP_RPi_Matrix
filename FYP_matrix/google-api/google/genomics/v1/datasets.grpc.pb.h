 ...
 public:
  ...
  class WithAsyncMethod_ListDatasets : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListDatasets(::grpc::ServerContext* context, const ::google::genomics::v1::ListDatasetsRequest* request, ::google::genomics::v1::ListDatasetsResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_CreateDataset : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CreateDataset(::grpc::ServerContext* context, const ::google::genomics::v1::CreateDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_GetDataset : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetDataset(::grpc::ServerContext* context, const ::google::genomics::v1::GetDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UpdateDataset : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateDataset(::grpc::ServerContext* context, const ::google::genomics::v1::UpdateDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteDataset : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteDataset(::grpc::ServerContext* context, const ::google::genomics::v1::DeleteDatasetRequest* request, ::google::protobuf::Empty* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UndeleteDataset : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UndeleteDataset(::grpc::ServerContext* context, const ::google::genomics::v1::UndeleteDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_UpdateDataset : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_UpdateDataset() {
      ::grpc::Service::MarkMethodRaw(3);
    }
    ~WithRawMethod_UpdateDataset() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UpdateDataset(::grpc::ServerContext* context, const ::google::genomics::v1::UpdateDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
    ...
    void RequestUpdateDataset(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawMethod_UndeleteDataset : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_UndeleteDataset() {
      ::grpc::Service::MarkMethodRaw(5);
    }
    ~WithRawMethod_UndeleteDataset() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UndeleteDataset(::grpc::ServerContext* context, const ::google::genomics::v1::UndeleteDatasetRequest* request, ::google::genomics::v1::Dataset* response) override {
    ...
    void RequestUndeleteDataset(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
