...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2fcigar_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_CigarUnit;
}  // namespace protobuf_google_2fgenomics_2fv1_2fcigar_2eproto
namespace protobuf_google_2fgenomics_2fv1_2fposition_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2fposition_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Position;
}  // namespace protobuf_google_2fgenomics_2fv1_2fposition_2eproto
namespace protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Read_InfoEntry_DoNotUse;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_LinearAlignment;
}  // namespace protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto
...
namespace protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto {
static void InitDefaultsLinearAlignment() {
...
::google::protobuf::internal::SCCInfo<2> scc_info_LinearAlignment =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsLinearAlignment}, {
      &protobuf_google_2fgenomics_2fv1_2fposition_2eproto::scc_info_Position.base,
      &protobuf_google_2fgenomics_2fv1_2fcigar_2eproto::scc_info_CigarUnit.base,}};

static void InitDefaultsRead_InfoEntry_DoNotUse() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_Read_InfoEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsRead_InfoEntry_DoNotUse}, {
      &protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base,}};

static void InitDefaultsRead() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<3> scc_info_Read =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsRead}, {
      &protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto::scc_info_LinearAlignment.base,
      &protobuf_google_2fgenomics_2fv1_2fposition_2eproto::scc_info_Position.base,
      &protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto::scc_info_Read_InfoEntry_DoNotUse.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_LinearAlignment.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Read_InfoEntry_DoNotUse.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Read.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/readalignment.proto", schemas, file_default_instances, TableStruct::offsets,
...
LinearAlignment::LinearAlignment(::google::protobuf::Arena* arena)
  ...
  cigar_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto::scc_info_LinearAlignment.base);
  SharedCtor();
...
Read::Read(::google::protobuf::Arena* arena)
  ...
  info_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadalignment_2eproto::scc_info_Read.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
void Read::SerializeWithCachedSizes(
  ...
  if (this->has_alignment()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      11, this->_internal_alignment(), output);
  }
  ...
  if (this->has_next_mate_position()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      16, this->_internal_next_mate_position(), output);
  }
  ...
  if (!this->info().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::unique_ptr<Read_InfoEntry_DoNotUse> entry;
...
::google::protobuf::uint8* Read::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_alignment()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        11, this->_internal_alignment(), deterministic, target);
  }
  ...
  if (this->has_next_mate_position()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        16, this->_internal_next_mate_position(), deterministic, target);
  }
...
void Read::InternalSwap(Read* other) {
  ...
  id_.Swap(&other->id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  read_group_id_.Swap(&other->read_group_id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  read_group_set_id_.Swap(&other->read_group_set_id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  fragment_name_.Swap(&other->fragment_name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  aligned_sequence_.Swap(&other->aligned_sequence_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::LinearAlignment* Arena::CreateMaybeMessage< ::google::genomics::v1::LinearAlignment >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::LinearAlignment >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::Read_InfoEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::genomics::v1::Read_InfoEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::Read_InfoEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::Read* Arena::CreateMaybeMessage< ::google::genomics::v1::Read >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::Read >(arena);
}
}  // namespace protobuf
}  // namespace google
