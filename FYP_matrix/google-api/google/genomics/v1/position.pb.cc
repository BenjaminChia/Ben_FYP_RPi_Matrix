...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/position.proto", schemas, file_default_instances, TableStruct::offsets,
...
Position::Position(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2fposition_2eproto::scc_info_Position.base);
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::Position* Arena::CreateMaybeMessage< ::google::genomics::v1::Position >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::Position >(arena);
}
}  // namespace protobuf
}  // namespace google
