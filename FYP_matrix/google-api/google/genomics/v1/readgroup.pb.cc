...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ReadGroup_Experiment;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ReadGroup_Program;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ReadGroup_InfoEntry_DoNotUse;
}  // namespace protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto
...
namespace protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto {
static void InitDefaultsReadGroup_Experiment() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ReadGroup_Experiment =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsReadGroup_Experiment}, {}};

static void InitDefaultsReadGroup_Program() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_ReadGroup_Program =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsReadGroup_Program}, {}};

static void InitDefaultsReadGroup_InfoEntry_DoNotUse() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_ReadGroup_InfoEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsReadGroup_InfoEntry_DoNotUse}, {
      &protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base,}};

static void InitDefaultsReadGroup() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<3> scc_info_ReadGroup =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsReadGroup}, {
      &protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup_Experiment.base,
      &protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup_Program.base,
      &protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup_InfoEntry_DoNotUse.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroup_Experiment.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroup_Program.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroup_InfoEntry_DoNotUse.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ReadGroup.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/genomics/v1/readgroup.proto", schemas, file_default_instances, TableStruct::offsets,
...
ReadGroup_Experiment::ReadGroup_Experiment(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup_Experiment.base);
  SharedCtor();
...
void ReadGroup_Experiment::InternalSwap(ReadGroup_Experiment* other) {
  using std::swap;
  library_id_.Swap(&other->library_id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  platform_unit_.Swap(&other->platform_unit_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sequencing_center_.Swap(&other->sequencing_center_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  instrument_model_.Swap(&other->instrument_model_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
ReadGroup_Program::ReadGroup_Program(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup_Program.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
void ReadGroup_Program::InternalSwap(ReadGroup_Program* other) {
  ...
  name_.Swap(&other->name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  prev_program_id_.Swap(&other->prev_program_id_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
ReadGroup::ReadGroup()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup.base);
  SharedCtor();
...
ReadGroup::ReadGroup(::google::protobuf::Arena* arena)
  ...
  programs_(arena),
  info_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fgenomics_2fv1_2freadgroup_2eproto::scc_info_ReadGroup.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
void ReadGroup::SerializeWithCachedSizes(
  ...
  if (this->has_experiment()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->_internal_experiment(), output);
  }
  ...
  if (!this->info().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::unique_ptr<ReadGroup_InfoEntry_DoNotUse> entry;
  ...
  if (this->has_experiment()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, this->_internal_experiment(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroup_Experiment* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroup_Experiment >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroup_Experiment >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroup_Program* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroup_Program >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroup_Program >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroup_InfoEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroup_InfoEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroup_InfoEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::genomics::v1::ReadGroup* Arena::CreateMaybeMessage< ::google::genomics::v1::ReadGroup >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::genomics::v1::ReadGroup >(arena);
}
}  // namespace protobuf
}  // namespace google
