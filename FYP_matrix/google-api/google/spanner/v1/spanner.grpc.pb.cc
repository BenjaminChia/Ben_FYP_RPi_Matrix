...
Spanner::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_ListSessions_(Spanner_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteSession_(Spanner_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExecuteSql_(Spanner_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExecuteStreamingSql_(Spanner_method_names[5], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_Read_(Spanner_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StreamingRead_(Spanner_method_names[7], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_BeginTransaction_(Spanner_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Commit_(Spanner_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Rollback_(Spanner_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PartitionQuery_(Spanner_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PartitionRead_(Spanner_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Spanner::Stub::ListSessions(::grpc::ClientContext* context, const ::google::spanner::v1::ListSessionsRequest& request, ::google::spanner::v1::ListSessionsResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ListSessions_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ListSessionsResponse>* Spanner::Stub::AsyncListSessionsRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ListSessionsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::ListSessionsResponse>::Create(channel_.get(), cq, rpcmethod_ListSessions_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::ListSessionsResponse>* Spanner::Stub::PrepareAsyncListSessionsRaw(::grpc::ClientContext* context, const ::google::spanner::v1::ListSessionsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::ListSessionsResponse>::Create(channel_.get(), cq, rpcmethod_ListSessions_, context, request, false);
}
...
::grpc::Status Spanner::Stub::PartitionQuery(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionQueryRequest& request, ::google::spanner::v1::PartitionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_PartitionQuery_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::PartitionResponse>* Spanner::Stub::AsyncPartitionQueryRaw(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionQueryRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::PartitionResponse>::Create(channel_.get(), cq, rpcmethod_PartitionQuery_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::PartitionResponse>* Spanner::Stub::PrepareAsyncPartitionQueryRaw(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionQueryRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::PartitionResponse>::Create(channel_.get(), cq, rpcmethod_PartitionQuery_, context, request, false);
}

::grpc::Status Spanner::Stub::PartitionRead(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionReadRequest& request, ::google::spanner::v1::PartitionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_PartitionRead_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::PartitionResponse>* Spanner::Stub::AsyncPartitionReadRaw(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionReadRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::PartitionResponse>::Create(channel_.get(), cq, rpcmethod_PartitionRead_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::spanner::v1::PartitionResponse>* Spanner::Stub::PrepareAsyncPartitionReadRaw(::grpc::ClientContext* context, const ::google::spanner::v1::PartitionReadRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::spanner::v1::PartitionResponse>::Create(channel_.get(), cq, rpcmethod_PartitionRead_, context, request, false);
}
...
Spanner::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::ListSessionsRequest, ::google::spanner::v1::ListSessionsResponse>(
          std::mem_fn(&Spanner::Service::ListSessions), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Spanner_method_names[11],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::PartitionQueryRequest, ::google::spanner::v1::PartitionResponse>(
          std::mem_fn(&Spanner::Service::PartitionQuery), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Spanner_method_names[12],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Spanner::Service, ::google::spanner::v1::PartitionReadRequest, ::google::spanner::v1::PartitionResponse>(
          std::mem_fn(&Spanner::Service::PartitionRead), this)));
}
...
::grpc::Status Spanner::Service::ListSessions(::grpc::ServerContext* context, const ::google::spanner::v1::ListSessionsRequest* request, ::google::spanner::v1::ListSessionsResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Spanner::Service::PartitionQuery(::grpc::ServerContext* context, const ::google::spanner::v1::PartitionQueryRequest* request, ::google::spanner::v1::PartitionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Spanner::Service::PartitionRead(::grpc::ServerContext* context, const ::google::spanner::v1::PartitionReadRequest* request, ::google::spanner::v1::PartitionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
