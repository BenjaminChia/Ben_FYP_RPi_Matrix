...
#ifndef PROTOBUF_INCLUDED_google_2fspanner_2fv1_2fmutation_2eproto
#define PROTOBUF_INCLUDED_google_2fspanner_2fv1_2fmutation_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fspanner_2fv1_2fmutation_2eproto 
...
class Mutation_Write : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.v1.Mutation.Write) */ {
 public:
  ...
  inline Mutation_Write* New() const final {
    return CreateMaybeMessage<Mutation_Write>(NULL);
  }

  Mutation_Write* New(::google::protobuf::Arena* arena) const final {
...
class Mutation_Delete : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.v1.Mutation.Delete) */ {
 public:
  ...
  inline Mutation_Delete* New() const final {
    return CreateMaybeMessage<Mutation_Delete>(NULL);
  }

  Mutation_Delete* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fspanner_2fv1_2fmutation_2eproto
