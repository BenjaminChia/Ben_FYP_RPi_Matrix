...
#ifndef PROTOBUF_INCLUDED_google_2fspanner_2fadmin_2finstance_2fv1_2fspanner_5finstance_5fadmin_2eproto
#define PROTOBUF_INCLUDED_google_2fspanner_2fadmin_2finstance_2fv1_2fspanner_5finstance_5fadmin_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fspanner_2fadmin_2finstance_2fv1_2fspanner_5finstance_5fadmin_2eproto 
...
class InstanceConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.admin.instance.v1.InstanceConfig) */ {
 public:
  ...
  inline InstanceConfig* New() const final {
    return CreateMaybeMessage<InstanceConfig>(NULL);
  }

  InstanceConfig* New(::google::protobuf::Arena* arena) const final {
...
class ListInstanceConfigsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.admin.instance.v1.ListInstanceConfigsRequest) */ {
 public:
  ...
  inline ListInstanceConfigsRequest* New() const final {
    return CreateMaybeMessage<ListInstanceConfigsRequest>(NULL);
  }

  ListInstanceConfigsRequest* New(::google::protobuf::Arena* arena) const final {
...
class ListInstanceConfigsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.admin.instance.v1.ListInstanceConfigsResponse) */ {
 public:
  ...
  inline ListInstanceConfigsResponse* New() const final {
    return CreateMaybeMessage<ListInstanceConfigsResponse>(NULL);
  }

  ListInstanceConfigsResponse* New(::google::protobuf::Arena* arena) const final {
...
class GetInstanceConfigRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.spanner.admin.instance.v1.GetInstanceConfigRequest) */ {
 public:
  ...
  inline GetInstanceConfigRequest* New() const final {
    return CreateMaybeMessage<GetInstanceConfigRequest>(NULL);
  }

  GetInstanceConfigRequest* New(::google::protobuf::Arena* arena) const final {
...
inline const ::google::protobuf::FieldMask& UpdateInstanceRequest::_internal_field_mask() const {
  return *field_mask_;
}
...
inline const ::google::protobuf::Timestamp& CreateInstanceMetadata::_internal_start_time() const {
  return *start_time_;
}
...
inline const ::google::protobuf::Timestamp& CreateInstanceMetadata::_internal_cancel_time() const {
  return *cancel_time_;
}
...
inline const ::google::protobuf::Timestamp& CreateInstanceMetadata::_internal_end_time() const {
  return *end_time_;
}
...
inline const ::google::protobuf::Timestamp& UpdateInstanceMetadata::_internal_start_time() const {
  return *start_time_;
}
...
inline const ::google::protobuf::Timestamp& UpdateInstanceMetadata::_internal_cancel_time() const {
  return *cancel_time_;
}
...
inline const ::google::protobuf::Timestamp& UpdateInstanceMetadata::_internal_end_time() const {
  return *end_time_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fspanner_2fadmin_2finstance_2fv1_2fspanner_5finstance_5fadmin_2eproto
