   ...
   public:
    WithStreamedUnaryMethod_ListAlertPolicies() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::monitoring::v3::ListAlertPoliciesRequest, ::google::monitoring::v3::ListAlertPoliciesResponse>(std::bind(&WithStreamedUnaryMethod_ListAlertPolicies<BaseClass>::StreamedListAlertPolicies, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetAlertPolicy() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::google::monitoring::v3::GetAlertPolicyRequest, ::google::monitoring::v3::AlertPolicy>(std::bind(&WithStreamedUnaryMethod_GetAlertPolicy<BaseClass>::StreamedGetAlertPolicy, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_CreateAlertPolicy() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::google::monitoring::v3::CreateAlertPolicyRequest, ::google::monitoring::v3::AlertPolicy>(std::bind(&WithStreamedUnaryMethod_CreateAlertPolicy<BaseClass>::StreamedCreateAlertPolicy, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_DeleteAlertPolicy() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler< ::google::monitoring::v3::DeleteAlertPolicyRequest, ::google::protobuf::Empty>(std::bind(&WithStreamedUnaryMethod_DeleteAlertPolicy<BaseClass>::StreamedDeleteAlertPolicy, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_UpdateAlertPolicy() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler< ::google::monitoring::v3::UpdateAlertPolicyRequest, ::google::monitoring::v3::AlertPolicy>(std::bind(&WithStreamedUnaryMethod_UpdateAlertPolicy<BaseClass>::StreamedUpdateAlertPolicy, this, std::placeholders::_1, std::placeholders::_2)));
    }
