...
#ifndef PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fgroup_5fservice_2eproto
#define PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fgroup_5fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fmonitoring_2fv3_2fgroup_5fservice_2eproto 
...
class ListGroupsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.monitoring.v3.ListGroupsResponse) */ {
 public:
  ...
  inline ListGroupsResponse* New() const final {
    return CreateMaybeMessage<ListGroupsResponse>(NULL);
  }
...
class ListGroupMembersRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.monitoring.v3.ListGroupMembersRequest) */ {
 public:
  ...
  inline ListGroupMembersRequest* New() const final {
    return CreateMaybeMessage<ListGroupMembersRequest>(NULL);
  }

  ListGroupMembersRequest* New(::google::protobuf::Arena* arena) const final {
...
class ListGroupMembersResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.monitoring.v3.ListGroupMembersResponse) */ {
 public:
  ...
  inline ListGroupMembersResponse* New() const final {
    return CreateMaybeMessage<ListGroupMembersResponse>(NULL);
  }

  ListGroupMembersResponse* New(::google::protobuf::Arena* arena) const final {
...
inline void ListGroupsRequest::set_children_of_group(::std::string&& value) {
  ...
  filter_.children_of_group_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ListGroupsRequest::set_allocated_children_of_group(::std::string* children_of_group) {
  ...
  if (children_of_group != NULL) {
    set_has_children_of_group();
    filter_.children_of_group_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), children_of_group);
  }
...
inline void ListGroupsRequest::set_ancestors_of_group(::std::string&& value) {
  ...
  filter_.ancestors_of_group_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ListGroupsRequest::set_allocated_ancestors_of_group(::std::string* ancestors_of_group) {
  ...
  if (ancestors_of_group != NULL) {
    set_has_ancestors_of_group();
    filter_.ancestors_of_group_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ancestors_of_group);
  }
...
inline void ListGroupsRequest::set_descendants_of_group(::std::string&& value) {
  ...
  filter_.descendants_of_group_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ListGroupsRequest::set_allocated_descendants_of_group(::std::string* descendants_of_group) {
  ...
  if (descendants_of_group != NULL) {
    set_has_descendants_of_group();
    filter_.descendants_of_group_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), descendants_of_group);
  }
...
inline ::google::monitoring::v3::Group* CreateGroupRequest::mutable_group() {
  ...
  if (group_ == NULL) {
    auto* p = CreateMaybeMessage<::google::monitoring::v3::Group>(GetArenaNoVirtual());
    group_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fgroup_5fservice_2eproto
