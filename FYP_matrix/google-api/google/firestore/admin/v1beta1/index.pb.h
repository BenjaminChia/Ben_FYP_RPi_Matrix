...
#ifndef PROTOBUF_INCLUDED_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto
#define PROTOBUF_INCLUDED_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::firestore::admin::v1beta1::Index* Arena::CreateMaybeMessage<::google::firestore::admin::v1beta1::Index>(Arena*);
template<> ::google::firestore::admin::v1beta1::IndexField* Arena::CreateMaybeMessage<::google::firestore::admin::v1beta1::IndexField>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace firestore {
...
enum IndexField_Mode {
  ...
  IndexField_Mode_ARRAY_CONTAINS = 4,
...
const IndexField_Mode IndexField_Mode_Mode_MAX = IndexField_Mode_ARRAY_CONTAINS;
...
class IndexField : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.admin.v1beta1.IndexField) */ {
 public:
  ...
  inline IndexField* New() const final {
    return CreateMaybeMessage<IndexField>(NULL);
  }

  IndexField* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<IndexField>(arena);
  }
  ...
  static const Mode ARRAY_CONTAINS =
    IndexField_Mode_ARRAY_CONTAINS;
...
template <> struct is_proto_enum< ::google::firestore::admin::v1beta1::IndexField_Mode> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::firestore::admin::v1beta1::Index_State> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto
