...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_IndexField;
}  // namespace protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto
namespace google {
namespace firestore {
namespace admin {
...
namespace protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto {
static void InitDefaultsIndexField() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_IndexField =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsIndexField}, {}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_Index =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsIndex}, {
      &protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto::scc_info_IndexField.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_IndexField.base);
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/firestore/admin/v1beta1/index.proto", schemas, file_default_instances, TableStruct::offsets,
...
const IndexField_Mode IndexField::ARRAY_CONTAINS;
...
const IndexField& IndexField::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto::scc_info_IndexField.base);
...
const Index& Index::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ffirestore_2fadmin_2fv1beta1_2findex_2eproto::scc_info_Index.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::admin::v1beta1::IndexField* Arena::CreateMaybeMessage< ::google::firestore::admin::v1beta1::IndexField >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::admin::v1beta1::IndexField >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::admin::v1beta1::Index* Arena::CreateMaybeMessage< ::google::firestore::admin::v1beta1::Index >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::admin::v1beta1::Index >(arena);
}
}  // namespace protobuf
}  // namespace google
