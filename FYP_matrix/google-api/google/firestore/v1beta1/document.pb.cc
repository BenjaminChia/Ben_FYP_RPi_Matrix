...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ffirestore_2fv1beta1_2fdocument_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Document_FieldsEntry_DoNotUse;
...
namespace protobuf_google_2ffirestore_2fv1beta1_2fdocument_2eproto {
static void InitDefaultsDocument_FieldsEntry_DoNotUse() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Document_FieldsEntry_DoNotUse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsDocument_FieldsEntry_DoNotUse}, {
...
::google::protobuf::internal::SCCInfo<2> scc_info_Document =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsDocument}, {
      &protobuf_google_2ffirestore_2fv1beta1_2fdocument_2eproto::scc_info_Document_FieldsEntry_DoNotUse.base,
...
::google::protobuf::internal::SCCInfo<2> scc_info_ArrayValue =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsArrayValue}, {
      &protobuf_google_2fprotobuf_2ftimestamp_2eproto::scc_info_Timestamp.base,
      &protobuf_google_2ftype_2flatlng_2eproto::scc_info_LatLng.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Document_FieldsEntry_DoNotUse.base);
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/firestore/v1beta1/document.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Document& Document::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ffirestore_2fv1beta1_2fdocument_2eproto::scc_info_Document.base);
...
const Value& Value::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ffirestore_2fv1beta1_2fdocument_2eproto::scc_info_ArrayValue.base);
  return *internal_default_instance();
}
...
::google::protobuf::uint8* Value::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_map_value()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, this->_internal_map_value(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::Document_FieldsEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::Document_FieldsEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::Document_FieldsEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::Document* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::Document >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::Document >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::Value* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::Value >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::Value >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::ArrayValue* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::ArrayValue >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::ArrayValue >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::MapValue_FieldsEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::MapValue_FieldsEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::MapValue_FieldsEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::firestore::v1beta1::MapValue* Arena::CreateMaybeMessage< ::google::firestore::v1beta1::MapValue >(Arena* arena) {
  return Arena::CreateInternal< ::google::firestore::v1beta1::MapValue >(arena);
}
}  // namespace protobuf
}  // namespace google
