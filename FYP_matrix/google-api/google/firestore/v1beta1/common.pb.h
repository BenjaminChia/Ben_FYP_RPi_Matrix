...
#ifndef PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fcommon_2eproto
#define PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fcommon_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ffirestore_2fv1beta1_2fcommon_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::firestore::v1beta1::DocumentMask* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentMask>(Arena*);
template<> ::google::firestore::v1beta1::Precondition* Arena::CreateMaybeMessage<::google::firestore::v1beta1::Precondition>(Arena*);
template<> ::google::firestore::v1beta1::TransactionOptions* Arena::CreateMaybeMessage<::google::firestore::v1beta1::TransactionOptions>(Arena*);
template<> ::google::firestore::v1beta1::TransactionOptions_ReadOnly* Arena::CreateMaybeMessage<::google::firestore::v1beta1::TransactionOptions_ReadOnly>(Arena*);
template<> ::google::firestore::v1beta1::TransactionOptions_ReadWrite* Arena::CreateMaybeMessage<::google::firestore::v1beta1::TransactionOptions_ReadWrite>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace firestore {
...
class DocumentMask : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentMask) */ {
 public:
  ...
  inline DocumentMask* New() const final {
    return CreateMaybeMessage<DocumentMask>(NULL);
  }

  DocumentMask* New(::google::protobuf::Arena* arena) const final {
...
class Precondition : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.Precondition) */ {
 public:
  ...
  inline Precondition* New() const final {
    return CreateMaybeMessage<Precondition>(NULL);
  }

  Precondition* New(::google::protobuf::Arena* arena) const final {
...
class TransactionOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.TransactionOptions) */ {
 public:
  ...
  private:
  const ::google::firestore::v1beta1::TransactionOptions_ReadOnly& _internal_read_only() const;
  public:
  ...
  private:
  const ::google::firestore::v1beta1::TransactionOptions_ReadWrite& _internal_read_write() const;
  public:
...
inline ::google::protobuf::Timestamp* Precondition::mutable_update_time() {
  if (!has_update_time()) {
    clear_condition_type();
    set_has_update_time();
    condition_type_.update_time_ = CreateMaybeMessage< ::google::protobuf::Timestamp >(
        GetArenaNoVirtual());
  }
...
inline const ::google::firestore::v1beta1::TransactionOptions_ReadOnly& TransactionOptions::_internal_read_only() const {
...
inline ::google::firestore::v1beta1::TransactionOptions_ReadOnly* TransactionOptions::mutable_read_only() {
  if (!has_read_only()) {
    clear_mode();
    set_has_read_only();
    mode_.read_only_ = CreateMaybeMessage< ::google::firestore::v1beta1::TransactionOptions_ReadOnly >(
        GetArenaNoVirtual());
  }
...
inline const ::google::firestore::v1beta1::TransactionOptions_ReadWrite& TransactionOptions::_internal_read_write() const {
...
inline ::google::firestore::v1beta1::TransactionOptions_ReadWrite* TransactionOptions::mutable_read_write() {
  if (!has_read_write()) {
    clear_mode();
    set_has_read_write();
    mode_.read_write_ = CreateMaybeMessage< ::google::firestore::v1beta1::TransactionOptions_ReadWrite >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fcommon_2eproto
