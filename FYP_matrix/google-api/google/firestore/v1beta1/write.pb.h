...
#ifndef PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fwrite_2eproto
#define PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fwrite_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ffirestore_2fv1beta1_2fwrite_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::firestore::v1beta1::DocumentChange* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentChange>(Arena*);
template<> ::google::firestore::v1beta1::DocumentDelete* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentDelete>(Arena*);
template<> ::google::firestore::v1beta1::DocumentRemove* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentRemove>(Arena*);
template<> ::google::firestore::v1beta1::DocumentTransform* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentTransform>(Arena*);
template<> ::google::firestore::v1beta1::DocumentTransform_FieldTransform* Arena::CreateMaybeMessage<::google::firestore::v1beta1::DocumentTransform_FieldTransform>(Arena*);
template<> ::google::firestore::v1beta1::ExistenceFilter* Arena::CreateMaybeMessage<::google::firestore::v1beta1::ExistenceFilter>(Arena*);
template<> ::google::firestore::v1beta1::Write* Arena::CreateMaybeMessage<::google::firestore::v1beta1::Write>(Arena*);
template<> ::google::firestore::v1beta1::WriteResult* Arena::CreateMaybeMessage<::google::firestore::v1beta1::WriteResult>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace firestore {
...
class Write : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.Write) */ {
 public:
  ...
  inline Write* New() const final {
    return CreateMaybeMessage<Write>(NULL);
  }
  ...
  private:
  const ::google::firestore::v1beta1::Document& _internal_update() const;
  public:
  ...
  private:
  const ::google::firestore::v1beta1::DocumentTransform& _internal_transform() const;
  public:
...
class DocumentTransform_FieldTransform : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentTransform.FieldTransform) */ {
 public:
  ...
  inline DocumentTransform_FieldTransform* New() const final {
    return CreateMaybeMessage<DocumentTransform_FieldTransform>(NULL);
  }
  ...
  private:
  const ::google::firestore::v1beta1::ArrayValue& _internal_append_missing_elements() const;
  public:
  ...
  private:
  const ::google::firestore::v1beta1::ArrayValue& _internal_remove_all_from_array() const;
  public:
...
class DocumentTransform : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentTransform) */ {
 public:
  ...
  inline DocumentTransform* New() const final {
    return CreateMaybeMessage<DocumentTransform>(NULL);
  }
...
class WriteResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.WriteResult) */ {
 public:
  ...
  inline WriteResult* New() const final {
    return CreateMaybeMessage<WriteResult>(NULL);
  }
...
class DocumentChange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentChange) */ {
 public:
  ...
  inline DocumentChange* New() const final {
    return CreateMaybeMessage<DocumentChange>(NULL);
  }
...
class DocumentDelete : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentDelete) */ {
 public:
  ...
  inline DocumentDelete* New() const final {
    return CreateMaybeMessage<DocumentDelete>(NULL);
  }
...
class DocumentRemove : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentRemove) */ {
 public:
  ...
  inline DocumentRemove* New() const final {
    return CreateMaybeMessage<DocumentRemove>(NULL);
  }
...
class ExistenceFilter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.ExistenceFilter) */ {
 public:
  ...
  inline ExistenceFilter* New() const final {
    return CreateMaybeMessage<ExistenceFilter>(NULL);
  }
...
inline const ::google::firestore::v1beta1::Document& Write::_internal_update() const {
...
inline ::google::firestore::v1beta1::Document* Write::mutable_update() {
  if (!has_update()) {
    clear_operation();
    set_has_update();
    operation_.update_ = CreateMaybeMessage< ::google::firestore::v1beta1::Document >(
        GetArenaNoVirtual());
  }
...
inline void Write::set_allocated_delete_(::std::string* delete_) {
  ...
  if (delete_ != NULL) {
    set_has_delete_();
    operation_.delete__.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), delete_);
  }
...
inline const ::google::firestore::v1beta1::DocumentTransform& Write::_internal_transform() const {
...
inline ::google::firestore::v1beta1::DocumentTransform* Write::mutable_transform() {
  if (!has_transform()) {
    clear_operation();
    set_has_transform();
    operation_.transform_ = CreateMaybeMessage< ::google::firestore::v1beta1::DocumentTransform >(
        GetArenaNoVirtual());
  }
...
inline const ::google::firestore::v1beta1::DocumentMask& Write::_internal_update_mask() const {
  return *update_mask_;
}
...
inline const ::google::firestore::v1beta1::Precondition& Write::_internal_current_document() const {
...
inline const ::google::firestore::v1beta1::ArrayValue& DocumentTransform_FieldTransform::_internal_append_missing_elements() const {
...
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::mutable_append_missing_elements() {
  if (!has_append_missing_elements()) {
    ...
    transform_type_.append_missing_elements_ = CreateMaybeMessage< ::google::firestore::v1beta1::ArrayValue >(
        GetArenaNoVirtual());
  }
...
inline const ::google::firestore::v1beta1::ArrayValue& DocumentTransform_FieldTransform::_internal_remove_all_from_array() const {
...
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::mutable_remove_all_from_array() {
  if (!has_remove_all_from_array()) {
    ...
    transform_type_.remove_all_from_array_ = CreateMaybeMessage< ::google::firestore::v1beta1::ArrayValue >(
        GetArenaNoVirtual());
  }
...
inline const ::google::firestore::v1beta1::Document& DocumentChange::_internal_document() const {
  return *document_;
}
...
template <> struct is_proto_enum< ::google::firestore::v1beta1::DocumentTransform_FieldTransform_ServerValue> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2ffirestore_2fv1beta1_2fwrite_2eproto
