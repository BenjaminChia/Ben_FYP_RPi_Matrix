...
::grpc::ClientAsyncResponseReader< ::google::datastore::v1beta3::ReserveIdsResponse>* Datastore::Stub::AsyncReserveIdsRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::ReserveIdsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::datastore::v1beta3::ReserveIdsResponse>::Create(channel_.get(), cq, rpcmethod_ReserveIds_, context, request, true);
}
...
::grpc::ClientAsyncResponseReader< ::google::datastore::v1beta3::ReserveIdsResponse>* Datastore::Stub::PrepareAsyncReserveIdsRaw(::grpc::ClientContext* context, const ::google::datastore::v1beta3::ReserveIdsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::datastore::v1beta3::ReserveIdsResponse>::Create(channel_.get(), cq, rpcmethod_ReserveIds_, context, request, false);
}
...
Datastore::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Datastore::Service, ::google::datastore::v1beta3::ReserveIdsRequest, ::google::datastore::v1beta3::ReserveIdsResponse>(
