...
#ifndef PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fquery_2eproto
#define PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fquery_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fdatastore_2fv1_2fquery_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::datastore::v1::CompositeFilter* Arena::CreateMaybeMessage<::google::datastore::v1::CompositeFilter>(Arena*);
template<> ::google::datastore::v1::EntityResult* Arena::CreateMaybeMessage<::google::datastore::v1::EntityResult>(Arena*);
template<> ::google::datastore::v1::Filter* Arena::CreateMaybeMessage<::google::datastore::v1::Filter>(Arena*);
template<> ::google::datastore::v1::GqlQuery* Arena::CreateMaybeMessage<::google::datastore::v1::GqlQuery>(Arena*);
template<> ::google::datastore::v1::GqlQueryParameter* Arena::CreateMaybeMessage<::google::datastore::v1::GqlQueryParameter>(Arena*);
template<> ::google::datastore::v1::GqlQuery_NamedBindingsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::datastore::v1::GqlQuery_NamedBindingsEntry_DoNotUse>(Arena*);
template<> ::google::datastore::v1::KindExpression* Arena::CreateMaybeMessage<::google::datastore::v1::KindExpression>(Arena*);
template<> ::google::datastore::v1::Projection* Arena::CreateMaybeMessage<::google::datastore::v1::Projection>(Arena*);
template<> ::google::datastore::v1::PropertyFilter* Arena::CreateMaybeMessage<::google::datastore::v1::PropertyFilter>(Arena*);
template<> ::google::datastore::v1::PropertyOrder* Arena::CreateMaybeMessage<::google::datastore::v1::PropertyOrder>(Arena*);
template<> ::google::datastore::v1::PropertyReference* Arena::CreateMaybeMessage<::google::datastore::v1::PropertyReference>(Arena*);
template<> ::google::datastore::v1::Query* Arena::CreateMaybeMessage<::google::datastore::v1::Query>(Arena*);
template<> ::google::datastore::v1::QueryResultBatch* Arena::CreateMaybeMessage<::google::datastore::v1::QueryResultBatch>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace datastore {
...
class EntityResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.EntityResult) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::Entity& _internal_entity() const;
  public:
...
class Query : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.Query) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::Filter& _internal_filter() const;
  public:
...
class Projection : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.Projection) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::PropertyReference& _internal_property() const;
  public:
...
class Filter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.Filter) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::CompositeFilter& _internal_composite_filter() const;
  public:
  ...
  private:
  const ::google::datastore::v1::PropertyFilter& _internal_property_filter() const;
  public:
...
class PropertyFilter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.PropertyFilter) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::Value& _internal_value() const;
  public:
...
inline const ::google::datastore::v1::Entity& EntityResult::_internal_entity() const {
  return *entity_;
}
...
inline ::google::datastore::v1::Entity* EntityResult::mutable_entity() {
  ...
  if (entity_ == NULL) {
    auto* p = CreateMaybeMessage<::google::datastore::v1::Entity>(GetArenaNoVirtual());
    entity_ = p;
  }
...
inline const ::google::datastore::v1::Filter& Query::_internal_filter() const {
  return *filter_;
}
...
inline ::google::datastore::v1::Filter* Query::mutable_filter() {
  ...
  if (filter_ == NULL) {
    auto* p = CreateMaybeMessage<::google::datastore::v1::Filter>(GetArenaNoVirtual());
    filter_ = p;
  }
...
inline const ::google::datastore::v1::PropertyReference& Projection::_internal_property() const {
  return *property_;
}
...
inline ::google::datastore::v1::PropertyReference* Projection::mutable_property() {
  ...
  if (property_ == NULL) {
    auto* p = CreateMaybeMessage<::google::datastore::v1::PropertyReference>(GetArenaNoVirtual());
    property_ = p;
  }
...
inline const ::google::datastore::v1::PropertyReference& PropertyOrder::_internal_property() const {
  return *property_;
}
...
inline const ::google::datastore::v1::CompositeFilter& Filter::_internal_composite_filter() const {
...
inline ::google::datastore::v1::CompositeFilter* Filter::mutable_composite_filter() {
  if (!has_composite_filter()) {
    ...
    filter_type_.composite_filter_ = CreateMaybeMessage< ::google::datastore::v1::CompositeFilter >(
        GetArenaNoVirtual());
  }
...
inline const ::google::datastore::v1::PropertyFilter& Filter::_internal_property_filter() const {
...
inline ::google::datastore::v1::PropertyFilter* Filter::mutable_property_filter() {
  if (!has_property_filter()) {
    ...
    filter_type_.property_filter_ = CreateMaybeMessage< ::google::datastore::v1::PropertyFilter >(
        GetArenaNoVirtual());
  }
...
inline const ::google::datastore::v1::PropertyReference& PropertyFilter::_internal_property() const {
  return *property_;
}
...
inline const ::google::datastore::v1::Value& PropertyFilter::_internal_value() const {
  return *value_;
}
...
inline ::google::datastore::v1::Value* PropertyFilter::mutable_value() {
  ...
  if (value_ == NULL) {
    auto* p = CreateMaybeMessage<::google::datastore::v1::Value>(GetArenaNoVirtual());
    value_ = p;
  }
...
inline const ::google::datastore::v1::Value& GqlQueryParameter::_internal_value() const {
...
inline ::google::datastore::v1::Value* GqlQueryParameter::mutable_value() {
  if (!has_value()) {
    ...
    set_has_value();
    parameter_type_.value_ = CreateMaybeMessage< ::google::datastore::v1::Value >(
        GetArenaNoVirtual());
  }
...
template <> struct is_proto_enum< ::google::datastore::v1::EntityResult_ResultType> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::datastore::v1::PropertyOrder_Direction> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::datastore::v1::CompositeFilter_Operator> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::datastore::v1::PropertyFilter_Operator> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::datastore::v1::QueryResultBatch_MoreResultsType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fquery_2eproto
