...
#ifndef PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fentity_2eproto
#define PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fentity_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fdatastore_2fv1_2fentity_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::datastore::v1::ArrayValue* Arena::CreateMaybeMessage<::google::datastore::v1::ArrayValue>(Arena*);
template<> ::google::datastore::v1::Entity* Arena::CreateMaybeMessage<::google::datastore::v1::Entity>(Arena*);
template<> ::google::datastore::v1::Entity_PropertiesEntry_DoNotUse* Arena::CreateMaybeMessage<::google::datastore::v1::Entity_PropertiesEntry_DoNotUse>(Arena*);
template<> ::google::datastore::v1::Key* Arena::CreateMaybeMessage<::google::datastore::v1::Key>(Arena*);
template<> ::google::datastore::v1::Key_PathElement* Arena::CreateMaybeMessage<::google::datastore::v1::Key_PathElement>(Arena*);
template<> ::google::datastore::v1::PartitionId* Arena::CreateMaybeMessage<::google::datastore::v1::PartitionId>(Arena*);
template<> ::google::datastore::v1::Value* Arena::CreateMaybeMessage<::google::datastore::v1::Value>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace datastore {
...
class Value : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.v1.Value) */ {
 public:
  ...
  private:
  const ::google::datastore::v1::Key& _internal_key_value() const;
  public:
  ...
  private:
  const ::google::datastore::v1::Entity& _internal_entity_value() const;
  public:
  ...
  private:
  const ::google::datastore::v1::ArrayValue& _internal_array_value() const;
  public:
...
inline const ::google::datastore::v1::PartitionId& Key::_internal_partition_id() const {
...
inline const ::google::datastore::v1::Key& Value::_internal_key_value() const {
...
inline ::google::datastore::v1::Key* Value::mutable_key_value() {
  if (!has_key_value()) {
    clear_value_type();
    set_has_key_value();
    value_type_.key_value_ = CreateMaybeMessage< ::google::datastore::v1::Key >(
        GetArenaNoVirtual());
  }
...
inline const ::google::datastore::v1::Entity& Value::_internal_entity_value() const {
...
inline ::google::datastore::v1::Entity* Value::mutable_entity_value() {
  if (!has_entity_value()) {
    ...
    value_type_.entity_value_ = CreateMaybeMessage< ::google::datastore::v1::Entity >(
        GetArenaNoVirtual());
  }
...
inline const ::google::datastore::v1::ArrayValue& Value::_internal_array_value() const {
...
inline ::google::datastore::v1::ArrayValue* Value::mutable_array_value() {
  if (!has_array_value()) {
    clear_value_type();
    set_has_array_value();
    value_type_.array_value_ = CreateMaybeMessage< ::google::datastore::v1::ArrayValue >(
        GetArenaNoVirtual());
  }
...
inline const ::google::datastore::v1::Key& Entity::_internal_key() const {
  return *key_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fdatastore_2fv1_2fentity_2eproto
