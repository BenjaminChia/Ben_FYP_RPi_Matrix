...
Datastore::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_ReserveIds_(Datastore_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Datastore::Stub::ReserveIds(::grpc::ClientContext* context, const ::google::datastore::v1::ReserveIdsRequest& request, ::google::datastore::v1::ReserveIdsResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ReserveIds_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::datastore::v1::ReserveIdsResponse>* Datastore::Stub::AsyncReserveIdsRaw(::grpc::ClientContext* context, const ::google::datastore::v1::ReserveIdsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::datastore::v1::ReserveIdsResponse>::Create(channel_.get(), cq, rpcmethod_ReserveIds_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::datastore::v1::ReserveIdsResponse>* Datastore::Stub::PrepareAsyncReserveIdsRaw(::grpc::ClientContext* context, const ::google::datastore::v1::ReserveIdsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::datastore::v1::ReserveIdsResponse>::Create(channel_.get(), cq, rpcmethod_ReserveIds_, context, request, false);
}
...
Datastore::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Datastore::Service, ::google::datastore::v1::ReserveIdsRequest, ::google::datastore::v1::ReserveIdsResponse>(
          std::mem_fn(&Datastore::Service::ReserveIds), this)));
}
...
::grpc::Status Datastore::Service::ReserveIds(::grpc::ServerContext* context, const ::google::datastore::v1::ReserveIdsRequest* request, ::google::datastore::v1::ReserveIdsResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
