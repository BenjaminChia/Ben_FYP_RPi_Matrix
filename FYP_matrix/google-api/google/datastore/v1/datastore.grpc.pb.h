   ...
   public:
    WithStreamedUnaryMethod_ReserveIds() {
      ::grpc::Service::MarkMethodStreamed(6,
        new ::grpc::internal::StreamedUnaryHandler< ::google::datastore::v1::ReserveIdsRequest, ::google::datastore::v1::ReserveIdsResponse>(std::bind(&WithStreamedUnaryMethod_ReserveIds<BaseClass>::StreamedReserveIds, this, std::placeholders::_1, std::placeholders::_2)));
    }
