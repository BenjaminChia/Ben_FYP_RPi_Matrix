...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fdatastore_2fv1_2fentity_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Key_PathElement;
...
::google::protobuf::internal::SCCInfo<2> scc_info_Key =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsKey}, {
      ...
      &protobuf_google_2fdatastore_2fv1_2fentity_2eproto::scc_info_Key_PathElement.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/datastore/v1/entity.proto", schemas, file_default_instances, TableStruct::offsets,
...
const PartitionId& PartitionId::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fdatastore_2fv1_2fentity_2eproto::scc_info_PartitionId.base);
...
const Key_PathElement& Key_PathElement::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fdatastore_2fv1_2fentity_2eproto::scc_info_Key_PathElement.base);
  return *internal_default_instance();
}
...
const Key& Key::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fdatastore_2fv1_2fentity_2eproto::scc_info_Key.base);
  return *internal_default_instance();
}
...
const ArrayValue& ArrayValue::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fdatastore_2fv1_2fentity_2eproto::scc_info_ArrayValue.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::PartitionId* Arena::CreateMaybeMessage< ::google::datastore::v1::PartitionId >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::PartitionId >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::Key_PathElement* Arena::CreateMaybeMessage< ::google::datastore::v1::Key_PathElement >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::Key_PathElement >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::Key* Arena::CreateMaybeMessage< ::google::datastore::v1::Key >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::Key >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::ArrayValue* Arena::CreateMaybeMessage< ::google::datastore::v1::ArrayValue >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::ArrayValue >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::Value* Arena::CreateMaybeMessage< ::google::datastore::v1::Value >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::Value >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::Entity_PropertiesEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::datastore::v1::Entity_PropertiesEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::Entity_PropertiesEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::datastore::v1::Entity* Arena::CreateMaybeMessage< ::google::datastore::v1::Entity >(Arena* arena) {
  return Arena::CreateInternal< ::google::datastore::v1::Entity >(arena);
}
}  // namespace protobuf
}  // namespace google
