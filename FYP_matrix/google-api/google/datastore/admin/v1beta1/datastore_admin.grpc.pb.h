 ...
 public:
  ...
  class WithAsyncMethod_ExportEntities : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ExportEntities(::grpc::ServerContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response) override {
      abort();
  ...
  class WithAsyncMethod_ImportEntities : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ImportEntities(::grpc::ServerContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
