...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fdatastore_2fadmin_2fv1_2findex_2eproto 
...
enum Index_AncestorMode {
  ...
  Index_AncestorMode_Index_AncestorMode_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Index_AncestorMode_Index_AncestorMode_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum Index_Direction {
  ...
  Index_Direction_Index_Direction_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Index_Direction_Index_Direction_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class Index_IndexedProperty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.admin.v1.Index.IndexedProperty) */ {
 public:
  ...
  inline Index_IndexedProperty* New() const final {
    return CreateMaybeMessage<Index_IndexedProperty>(NULL);
  }
 ...
 private:
  ...
  friend struct ::protobuf_google_2fdatastore_2fadmin_2fv1_2findex_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Index : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.datastore.admin.v1.Index) */ {
 public:
  Index();
  virtual ~Index();
