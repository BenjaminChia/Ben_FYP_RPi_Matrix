...
class DatastoreAdmin final {
 public:
  ...
  typedef WithAsyncMethod_ExportEntities<WithAsyncMethod_ImportEntities<WithAsyncMethod_GetIndex<WithAsyncMethod_ListIndexes<Service > > > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_ExportEntities() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::datastore::admin::v1::ExportEntitiesRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_ExportEntities<BaseClass>::StreamedExportEntities, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_ImportEntities() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::google::datastore::admin::v1::ImportEntitiesRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_ImportEntities<BaseClass>::StreamedImportEntities, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetIndex() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::google::datastore::admin::v1::GetIndexRequest, ::google::datastore::admin::v1::Index>(std::bind(&WithStreamedUnaryMethod_GetIndex<BaseClass>::StreamedGetIndex, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_ListIndexes() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler< ::google::datastore::admin::v1::ListIndexesRequest, ::google::datastore::admin::v1::ListIndexesResponse>(std::bind(&WithStreamedUnaryMethod_ListIndexes<BaseClass>::StreamedListIndexes, this, std::placeholders::_1, std::placeholders::_2)));
    }
  ...
  typedef WithStreamedUnaryMethod_ExportEntities<WithStreamedUnaryMethod_ImportEntities<WithStreamedUnaryMethod_GetIndex<WithStreamedUnaryMethod_ListIndexes<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_ExportEntities<WithStreamedUnaryMethod_ImportEntities<WithStreamedUnaryMethod_GetIndex<WithStreamedUnaryMethod_ListIndexes<Service > > > > StreamedService;
};
