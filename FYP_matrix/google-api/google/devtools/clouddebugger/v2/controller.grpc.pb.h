 ...
 public:
  ...
  class WithAsyncMethod_RegisterDebuggee : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status RegisterDebuggee(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::RegisterDebuggeeRequest* request, ::google::devtools::clouddebugger::v2::RegisterDebuggeeResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_ListActiveBreakpoints : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ListActiveBreakpoints(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::ListActiveBreakpointsRequest* request, ::google::devtools::clouddebugger::v2::ListActiveBreakpointsResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UpdateActiveBreakpoint : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateActiveBreakpoint(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::UpdateActiveBreakpointRequest* request, ::google::devtools::clouddebugger::v2::UpdateActiveBreakpointResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_RegisterDebuggee : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_RegisterDebuggee() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_RegisterDebuggee() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RegisterDebuggee(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::RegisterDebuggeeRequest* request, ::google::devtools::clouddebugger::v2::RegisterDebuggeeResponse* response) override {
    ...
    void RequestRegisterDebuggee(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_ListActiveBreakpoints : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListActiveBreakpoints() {
      ::grpc::Service::MarkMethodRaw(1);
    }
    ~WithRawMethod_ListActiveBreakpoints() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListActiveBreakpoints(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::ListActiveBreakpointsRequest* request, ::google::devtools::clouddebugger::v2::ListActiveBreakpointsResponse* response) override {
    ...
    void RequestListActiveBreakpoints(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_UpdateActiveBreakpoint : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_UpdateActiveBreakpoint() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_UpdateActiveBreakpoint() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UpdateActiveBreakpoint(::grpc::ServerContext* context, const ::google::devtools::clouddebugger::v2::UpdateActiveBreakpointRequest* request, ::google::devtools::clouddebugger::v2::UpdateActiveBreakpointResponse* response) override {
    ...
    void RequestUpdateActiveBreakpoint(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
