 ...
 public:
  ...
  class WithAsyncMethod_ListRepos : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListRepos(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::ListReposRequest* request, ::google::devtools::sourcerepo::v1::ListReposResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_GetRepo : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetRepo(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::GetRepoRequest* request, ::google::devtools::sourcerepo::v1::Repo* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CreateRepo : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CreateRepo(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::CreateRepoRequest* request, ::google::devtools::sourcerepo::v1::Repo* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteRepo : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteRepo(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::DeleteRepoRequest* request, ::google::protobuf::Empty* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_ListRepos : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListRepos() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_ListRepos() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListRepos(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::ListReposRequest* request, ::google::devtools::sourcerepo::v1::ListReposResponse* response) override {
    ...
    void RequestListRepos(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_GetRepo : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_GetRepo() {
      ::grpc::Service::MarkMethodRaw(1);
    }
    ~WithRawMethod_GetRepo() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetRepo(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::GetRepoRequest* request, ::google::devtools::sourcerepo::v1::Repo* response) override {
    ...
    void RequestGetRepo(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_CreateRepo : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_CreateRepo() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_CreateRepo() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CreateRepo(::grpc::ServerContext* context, const ::google::devtools::sourcerepo::v1::CreateRepoRequest* request, ::google::devtools::sourcerepo::v1::Repo* response) override {
    ...
    void RequestCreateRepo(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
