 ...
 public:
  ...
  class WithAsyncMethod_ListGroupStats : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListGroupStats(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::ListGroupStatsRequest* request, ::google::devtools::clouderrorreporting::v1beta1::ListGroupStatsResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_ListEvents : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ListEvents(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::ListEventsRequest* request, ::google::devtools::clouderrorreporting::v1beta1::ListEventsResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteEvents : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteEvents(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::DeleteEventsRequest* request, ::google::devtools::clouderrorreporting::v1beta1::DeleteEventsResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_ListGroupStats : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListGroupStats() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_ListGroupStats() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListGroupStats(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::ListGroupStatsRequest* request, ::google::devtools::clouderrorreporting::v1beta1::ListGroupStatsResponse* response) override {
    ...
    void RequestListGroupStats(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawMethod_DeleteEvents : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_DeleteEvents() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_DeleteEvents() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DeleteEvents(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::DeleteEventsRequest* request, ::google::devtools::clouderrorreporting::v1beta1::DeleteEventsResponse* response) override {
    ...
    void RequestDeleteEvents(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
