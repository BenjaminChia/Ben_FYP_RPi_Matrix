 ...
 public:
  ...
  class WithAsyncMethod_GetGroup : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status GetGroup(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::GetGroupRequest* request, ::google::devtools::clouderrorreporting::v1beta1::ErrorGroup* response) override {
      abort();
  ...
  class WithAsyncMethod_UpdateGroup : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateGroup(::grpc::ServerContext* context, const ::google::devtools::clouderrorreporting::v1beta1::UpdateGroupRequest* request, ::google::devtools::clouderrorreporting::v1beta1::ErrorGroup* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
