...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fiam_2fv1_2fpolicy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Binding;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fiam_2fv1_2fpolicy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_BindingDelta;
}  // namespace protobuf_google_2fiam_2fv1_2fpolicy_2eproto
namespace google {
namespace iam {
namespace v1 {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Policy =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPolicy}, {
      &protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_Binding.base,}};

static void InitDefaultsBinding() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_Binding =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsBinding}, {}};

static void InitDefaultsPolicyDelta() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_PolicyDelta =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPolicyDelta}, {
      &protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_BindingDelta.base,}};

static void InitDefaultsBindingDelta() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_BindingDelta =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsBindingDelta}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Policy.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Binding.base);
  ::google::protobuf::internal::InitSCC(&scc_info_PolicyDelta.base);
  ::google::protobuf::internal::InitSCC(&scc_info_BindingDelta.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/iam/v1/policy.proto", schemas, file_default_instances, TableStruct::offsets,
...
Policy::Policy(::google::protobuf::Arena* arena)
  ...
  bindings_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_Policy.base);
  SharedCtor();
...
Binding::Binding(::google::protobuf::Arena* arena)
  ...
  _internal_metadata_(arena),
  members_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_Binding.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
PolicyDelta::PolicyDelta()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_PolicyDelta.base);
  SharedCtor();
...
PolicyDelta::PolicyDelta(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_PolicyDelta.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
void PolicyDelta::InternalSwap(PolicyDelta* other) {
  using std::swap;
  CastToBase(&binding_deltas_)->InternalSwap(CastToBase(&other->binding_deltas_));
  _internal_metadata_.Swap(&other->_internal_metadata_);
}
...
BindingDelta::BindingDelta(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fiam_2fv1_2fpolicy_2eproto::scc_info_BindingDelta.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::iam::v1::Policy* Arena::CreateMaybeMessage< ::google::iam::v1::Policy >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::iam::v1::Policy >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::iam::v1::Binding* Arena::CreateMaybeMessage< ::google::iam::v1::Binding >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::iam::v1::Binding >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::iam::v1::PolicyDelta* Arena::CreateMaybeMessage< ::google::iam::v1::PolicyDelta >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::iam::v1::PolicyDelta >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::iam::v1::BindingDelta* Arena::CreateMaybeMessage< ::google::iam::v1::BindingDelta >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::iam::v1::BindingDelta >(arena);
}
}  // namespace protobuf
}  // namespace google
