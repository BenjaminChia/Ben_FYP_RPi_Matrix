...
::google::protobuf::internal::SCCInfo<0> scc_info_Zone =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsZone}, {}};
...
void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Zone.base);
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/bigtable/admin/cluster/v1/bigtable_cluster_data.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Zone& Zone::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fbigtable_2fadmin_2fcluster_2fv1_2fbigtable_5fcluster_5fdata_2eproto::scc_info_Zone.base);
...
const Cluster& Cluster::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fbigtable_2fadmin_2fcluster_2fv1_2fbigtable_5fcluster_5fdata_2eproto::scc_info_Cluster.base);
  return *internal_default_instance();
}
...
void Cluster::SerializeWithCachedSizes(
  ...
  if (this->has_current_operation()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->_internal_current_operation(), output);
  }
  ...
  if (this->has_current_operation()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->_internal_current_operation(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::cluster::v1::Zone* Arena::CreateMaybeMessage< ::google::bigtable::admin::cluster::v1::Zone >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::cluster::v1::Zone >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::cluster::v1::Cluster* Arena::CreateMaybeMessage< ::google::bigtable::admin::cluster::v1::Cluster >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::cluster::v1::Cluster >(arena);
}
}  // namespace protobuf
}  // namespace google
