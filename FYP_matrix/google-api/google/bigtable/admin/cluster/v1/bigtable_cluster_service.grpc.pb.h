 ...
 public:
  ...
  class WithAsyncMethod_ListZones : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListZones(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::ListZonesRequest* request, ::google::bigtable::admin::cluster::v1::ListZonesResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_GetCluster : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::GetClusterRequest* request, ::google::bigtable::admin::cluster::v1::Cluster* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_ListClusters : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ListClusters(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::ListClustersRequest* request, ::google::bigtable::admin::cluster::v1::ListClustersResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CreateCluster : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CreateCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::CreateClusterRequest* request, ::google::bigtable::admin::cluster::v1::Cluster* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UpdateCluster : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::Cluster* request, ::google::bigtable::admin::cluster::v1::Cluster* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteCluster : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::DeleteClusterRequest* request, ::google::protobuf::Empty* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UndeleteCluster : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UndeleteCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::UndeleteClusterRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_ListZones : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListZones() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_ListZones() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListZones(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::ListZonesRequest* request, ::google::bigtable::admin::cluster::v1::ListZonesResponse* response) override {
    ...
    void RequestListZones(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawMethod_UndeleteCluster : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_UndeleteCluster() {
      ::grpc::Service::MarkMethodRaw(6);
    }
    ~WithRawMethod_UndeleteCluster() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UndeleteCluster(::grpc::ServerContext* context, const ::google::bigtable::admin::cluster::v1::UndeleteClusterRequest* request, ::google::longrunning::Operation* response) override {
    ...
    void RequestUndeleteCluster(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(6, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
