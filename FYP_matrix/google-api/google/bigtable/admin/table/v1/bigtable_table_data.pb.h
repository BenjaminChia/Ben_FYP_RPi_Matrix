...
#ifndef PROTOBUF_INCLUDED_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto
#define PROTOBUF_INCLUDED_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::bigtable::admin::table::v1::ColumnFamily* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::ColumnFamily>(Arena*);
template<> ::google::bigtable::admin::table::v1::GcRule* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::GcRule>(Arena*);
template<> ::google::bigtable::admin::table::v1::GcRule_Intersection* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::GcRule_Intersection>(Arena*);
template<> ::google::bigtable::admin::table::v1::GcRule_Union* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::GcRule_Union>(Arena*);
template<> ::google::bigtable::admin::table::v1::Table* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::Table>(Arena*);
template<> ::google::bigtable::admin::table::v1::Table_ColumnFamiliesEntry_DoNotUse* Arena::CreateMaybeMessage<::google::bigtable::admin::table::v1::Table_ColumnFamiliesEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace bigtable {
...
class Table : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.admin.table.v1.Table) */ {
 public:
  ...
  private:
  const ::google::longrunning::Operation& _internal_current_operation() const;
  public:
...
class ColumnFamily : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.admin.table.v1.ColumnFamily) */ {
 public:
  ...
  private:
  const ::google::bigtable::admin::table::v1::GcRule& _internal_gc_rule() const;
  public:
...
class GcRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.admin.table.v1.GcRule) */ {
 public:
  ...
  private:
  const ::google::bigtable::admin::table::v1::GcRule_Intersection& _internal_intersection() const;
  public:
  ...
  private:
  const ::google::bigtable::admin::table::v1::GcRule_Union& _internal_union_() const;
  public:
...
inline const ::google::longrunning::Operation& Table::_internal_current_operation() const {
...
inline const ::google::bigtable::admin::table::v1::GcRule& ColumnFamily::_internal_gc_rule() const {
  return *gc_rule_;
}
...
inline ::google::bigtable::admin::table::v1::GcRule* ColumnFamily::mutable_gc_rule() {
  ...
  if (gc_rule_ == NULL) {
    auto* p = CreateMaybeMessage<::google::bigtable::admin::table::v1::GcRule>(GetArenaNoVirtual());
    gc_rule_ = p;
  }
...
inline const ::google::bigtable::admin::table::v1::GcRule_Intersection& GcRule::_internal_intersection() const {
...
inline ::google::bigtable::admin::table::v1::GcRule_Intersection* GcRule::mutable_intersection() {
  if (!has_intersection()) {
    ...
    rule_.intersection_ = CreateMaybeMessage< ::google::bigtable::admin::table::v1::GcRule_Intersection >(
        GetArenaNoVirtual());
  }
...
inline const ::google::bigtable::admin::table::v1::GcRule_Union& GcRule::_internal_union_() const {
...
inline ::google::bigtable::admin::table::v1::GcRule_Union* GcRule::mutable_union_() {
  if (!has_union_()) {
    clear_rule();
    set_has_union_();
    rule_.union__ = CreateMaybeMessage< ::google::bigtable::admin::table::v1::GcRule_Union >(
        GetArenaNoVirtual());
  }
...
template <> struct is_proto_enum< ::google::bigtable::admin::table::v1::Table_TimestampGranularity> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto
