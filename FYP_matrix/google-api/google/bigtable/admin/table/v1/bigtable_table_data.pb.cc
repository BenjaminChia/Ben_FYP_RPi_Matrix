...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_GcRule;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Table_ColumnFamiliesEntry_DoNotUse;
}  // namespace protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto
...
::google::protobuf::internal::SCCInfo<2> scc_info_Table =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsTable}, {
      ...
      &protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto::scc_info_Table_ColumnFamiliesEntry_DoNotUse.base,}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_ColumnFamily =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsColumnFamily}, {
      &protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto::scc_info_GcRule.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/bigtable/admin/table/v1/bigtable_table_data.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Table& Table::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto::scc_info_Table.base);
...
void Table::SerializeWithCachedSizes(
  ...
  if (this->has_current_operation()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->_internal_current_operation(), output);
  }
  ...
  if (this->has_current_operation()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, this->_internal_current_operation(), deterministic, target);
  }
...
const ColumnFamily& ColumnFamily::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto::scc_info_ColumnFamily.base);
  return *internal_default_instance();
}
...
void ColumnFamily::SerializeWithCachedSizes(
  ...
  if (this->has_gc_rule()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->_internal_gc_rule(), output);
  }
...
::google::protobuf::uint8* ColumnFamily::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_gc_rule()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->_internal_gc_rule(), deterministic, target);
  }
...
void ColumnFamily::InternalSwap(ColumnFamily* other) {
  ...
  name_.Swap(&other->name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  gc_expression_.Swap(&other->gc_expression_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
const GcRule_Intersection& GcRule_Intersection::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fbigtable_2fadmin_2ftable_2fv1_2fbigtable_5ftable_5fdata_2eproto::scc_info_GcRule.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::Table_ColumnFamiliesEntry_DoNotUse* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::Table_ColumnFamiliesEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::Table_ColumnFamiliesEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::Table* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::Table >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::Table >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::ColumnFamily* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::ColumnFamily >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::ColumnFamily >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::GcRule_Intersection* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::GcRule_Intersection >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::GcRule_Intersection >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::GcRule_Union* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::GcRule_Union >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::GcRule_Union >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::bigtable::admin::table::v1::GcRule* Arena::CreateMaybeMessage< ::google::bigtable::admin::table::v1::GcRule >(Arena* arena) {
  return Arena::CreateInternal< ::google::bigtable::admin::table::v1::GcRule >(arena);
}
}  // namespace protobuf
}  // namespace google
