...
#ifndef PROTOBUF_INCLUDED_google_2fbigtable_2fv1_2fbigtable_5fservice_5fmessages_2eproto
#define PROTOBUF_INCLUDED_google_2fbigtable_2fv1_2fbigtable_5fservice_5fmessages_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fbigtable_2fv1_2fbigtable_5fservice_5fmessages_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::bigtable::v1::CheckAndMutateRowRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::CheckAndMutateRowRequest>(Arena*);
template<> ::google::bigtable::v1::CheckAndMutateRowResponse* Arena::CreateMaybeMessage<::google::bigtable::v1::CheckAndMutateRowResponse>(Arena*);
template<> ::google::bigtable::v1::MutateRowRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::MutateRowRequest>(Arena*);
template<> ::google::bigtable::v1::MutateRowsRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::MutateRowsRequest>(Arena*);
template<> ::google::bigtable::v1::MutateRowsRequest_Entry* Arena::CreateMaybeMessage<::google::bigtable::v1::MutateRowsRequest_Entry>(Arena*);
template<> ::google::bigtable::v1::MutateRowsResponse* Arena::CreateMaybeMessage<::google::bigtable::v1::MutateRowsResponse>(Arena*);
template<> ::google::bigtable::v1::ReadModifyWriteRowRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::ReadModifyWriteRowRequest>(Arena*);
template<> ::google::bigtable::v1::ReadRowsRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::ReadRowsRequest>(Arena*);
template<> ::google::bigtable::v1::ReadRowsResponse* Arena::CreateMaybeMessage<::google::bigtable::v1::ReadRowsResponse>(Arena*);
template<> ::google::bigtable::v1::ReadRowsResponse_Chunk* Arena::CreateMaybeMessage<::google::bigtable::v1::ReadRowsResponse_Chunk>(Arena*);
template<> ::google::bigtable::v1::SampleRowKeysRequest* Arena::CreateMaybeMessage<::google::bigtable::v1::SampleRowKeysRequest>(Arena*);
template<> ::google::bigtable::v1::SampleRowKeysResponse* Arena::CreateMaybeMessage<::google::bigtable::v1::SampleRowKeysResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace bigtable {
...
class ReadRowsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.v1.ReadRowsRequest) */ {
 public:
  ...
  private:
  const ::google::bigtable::v1::RowFilter& _internal_filter() const;
  public:
  ...
  private:
  const ::google::bigtable::v1::RowRange& _internal_row_range() const;
  public:
  ...
  private:
  const ::google::bigtable::v1::RowSet& _internal_row_set() const;
  public:
...
class ReadRowsResponse_Chunk : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.v1.ReadRowsResponse.Chunk) */ {
 public:
  ...
  inline ReadRowsResponse_Chunk* New() const final {
    return CreateMaybeMessage<ReadRowsResponse_Chunk>(NULL);
  }

  ReadRowsResponse_Chunk* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ReadRowsResponse_Chunk>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  ...
  private:
  const ::google::bigtable::v1::Family& _internal_row_contents() const;
  public:
...
inline void ReadRowsRequest::set_row_key(::std::string&& value) {
  ...
  target_.row_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ReadRowsRequest::set_allocated_row_key(::std::string* row_key) {
  ...
  if (row_key != NULL) {
    set_has_row_key();
    target_.row_key_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), row_key);
  }
...
inline const ::google::bigtable::v1::RowRange& ReadRowsRequest::_internal_row_range() const {
...
inline ::google::bigtable::v1::RowRange* ReadRowsRequest::mutable_row_range() {
  if (!has_row_range()) {
    clear_target();
    set_has_row_range();
    target_.row_range_ = CreateMaybeMessage< ::google::bigtable::v1::RowRange >(
        GetArenaNoVirtual());
  }
...
inline const ::google::bigtable::v1::RowSet& ReadRowsRequest::_internal_row_set() const {
...
inline ::google::bigtable::v1::RowSet* ReadRowsRequest::mutable_row_set() {
  if (!has_row_set()) {
    clear_target();
    set_has_row_set();
    target_.row_set_ = CreateMaybeMessage< ::google::bigtable::v1::RowSet >(
        GetArenaNoVirtual());
  }
...
inline const ::google::bigtable::v1::RowFilter& ReadRowsRequest::_internal_filter() const {
  return *filter_;
}
...
inline const ::google::bigtable::v1::Family& ReadRowsResponse_Chunk::_internal_row_contents() const {
...
inline ::google::bigtable::v1::Family* ReadRowsResponse_Chunk::mutable_row_contents() {
  if (!has_row_contents()) {
    ...
    chunk_.row_contents_ = CreateMaybeMessage< ::google::bigtable::v1::Family >(
        GetArenaNoVirtual());
  }
...
inline const ::google::bigtable::v1::RowFilter& CheckAndMutateRowRequest::_internal_predicate_filter() const {
...
#endif  // PROTOBUF_INCLUDED_google_2fbigtable_2fv1_2fbigtable_5fservice_5fmessages_2eproto
