 ...
 public:
  ...
  class WithAsyncMethod_ListFunctions : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListFunctions(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::ListFunctionsRequest* request, ::google::cloud::functions::v1beta2::ListFunctionsResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_GetFunction : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::GetFunctionRequest* request, ::google::cloud::functions::v1beta2::CloudFunction* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CreateFunction : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CreateFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::CreateFunctionRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UpdateFunction : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::UpdateFunctionRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteFunction : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::DeleteFunctionRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CallFunction : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CallFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::CallFunctionRequest* request, ::google::cloud::functions::v1beta2::CallFunctionResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  template <class BaseClass>
  class WithRawMethod_ListFunctions : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_ListFunctions() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_ListFunctions() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListFunctions(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::ListFunctionsRequest* request, ::google::cloud::functions::v1beta2::ListFunctionsResponse* response) override {
    ...
    void RequestListFunctions(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawMethod_CreateFunction : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_CreateFunction() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_CreateFunction() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CreateFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::CreateFunctionRequest* request, ::google::longrunning::Operation* response) override {
    ...
    void RequestCreateFunction(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_UpdateFunction : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_UpdateFunction() {
      ::grpc::Service::MarkMethodRaw(3);
    }
    ~WithRawMethod_UpdateFunction() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UpdateFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::UpdateFunctionRequest* request, ::google::longrunning::Operation* response) override {
    ...
    void RequestUpdateFunction(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_DeleteFunction : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_DeleteFunction() {
      ::grpc::Service::MarkMethodRaw(4);
    }
    ~WithRawMethod_DeleteFunction() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DeleteFunction(::grpc::ServerContext* context, const ::google::cloud::functions::v1beta2::DeleteFunctionRequest* request, ::google::longrunning::Operation* response) override {
    ...
    void RequestDeleteFunction(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(4, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
