...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2ffunctions_2fv1beta2_2foperations_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2ffunctions_2fv1beta2_2foperations_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2ffunctions_2fv1beta2_2foperations_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::functions::v1beta2::OperationMetadataV1Beta2* Arena::CreateMaybeMessage<::google::cloud::functions::v1beta2::OperationMetadataV1Beta2>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class OperationMetadataV1Beta2 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.functions.v1beta2.OperationMetadataV1Beta2) */ {
 public:
  ...
  inline OperationMetadataV1Beta2* New() const final {
    return CreateMaybeMessage<OperationMetadataV1Beta2>(NULL);
  }

  OperationMetadataV1Beta2* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<OperationMetadataV1Beta2>(arena);
  }
...
inline const ::google::protobuf::Any& OperationMetadataV1Beta2::_internal_request() const {
  return *request_;
}
...
template <> struct is_proto_enum< ::google::cloud::functions::v1beta2::OperationType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2ffunctions_2fv1beta2_2foperations_2eproto
