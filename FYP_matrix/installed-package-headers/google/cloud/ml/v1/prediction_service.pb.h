...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2fml_2fv1_2fprediction_5fservice_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2fml_2fv1_2fprediction_5fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fml_2fv1_2fprediction_5fservice_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::ml::v1::PredictRequest* Arena::CreateMaybeMessage<::google::cloud::ml::v1::PredictRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class PredictRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.ml.v1.PredictRequest) */ {
 public:
  ...
  private:
  const ::google::api::HttpBody& _internal_http_body() const;
  public:
...
inline const ::google::api::HttpBody& PredictRequest::_internal_http_body() const {
  return *http_body_;
}
...
inline ::google::api::HttpBody* PredictRequest::mutable_http_body() {
  ...
  if (http_body_ == NULL) {
    auto* p = CreateMaybeMessage<::google::api::HttpBody>(GetArenaNoVirtual());
    http_body_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2fml_2fv1_2fprediction_5fservice_2eproto
