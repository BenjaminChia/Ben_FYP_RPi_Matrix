 ...
 public:
  ...
  class WithAsyncMethod_ListInstances : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListInstances(::grpc::ServerContext* context, const ::google::cloud::redis::v1beta1::ListInstancesRequest* request, ::google::cloud::redis::v1beta1::ListInstancesResponse* response) override {
      abort();
  ...
  class WithAsyncMethod_GetInstance : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetInstance(::grpc::ServerContext* context, const ::google::cloud::redis::v1beta1::GetInstanceRequest* request, ::google::cloud::redis::v1beta1::Instance* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CreateInstance : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CreateInstance(::grpc::ServerContext* context, const ::google::cloud::redis::v1beta1::CreateInstanceRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_UpdateInstance : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateInstance(::grpc::ServerContext* context, const ::google::cloud::redis::v1beta1::UpdateInstanceRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeleteInstance : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DeleteInstance(::grpc::ServerContext* context, const ::google::cloud::redis::v1beta1::DeleteInstanceRequest* request, ::google::longrunning::Operation* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
