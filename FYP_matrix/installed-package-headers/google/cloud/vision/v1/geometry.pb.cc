...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_NormalizedVertex;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Vertex;
}  // namespace protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto
namespace google {
namespace cloud {
namespace vision {
...
static void InitDefaultsNormalizedVertex() {
  ...
  {
    void* ptr = &::google::cloud::vision::v1::_NormalizedVertex_default_instance_;
    new (ptr) ::google::cloud::vision::v1::NormalizedVertex();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::google::cloud::vision::v1::NormalizedVertex::InitAsDefaultInstance();
}
...
::google::protobuf::internal::SCCInfo<2> scc_info_BoundingPoly =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsBoundingPoly}, {
      &protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_Vertex.base,
      &protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_NormalizedVertex.base,}};
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::cloud::vision::v1::NormalizedVertex, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::cloud::vision::v1::NormalizedVertex, x_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::cloud::vision::v1::NormalizedVertex, y_),
  ~0u,  // no _has_bits_
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::cloud::vision::v1::BoundingPoly, normalized_vertices_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, sizeof(::google::cloud::vision::v1::NormalizedVertex)},
  { 14, -1, sizeof(::google::cloud::vision::v1::BoundingPoly)},
  { 21, -1, sizeof(::google::cloud::vision::v1::Position)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::google::cloud::vision::v1::_Vertex_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::google::cloud::vision::v1::_NormalizedVertex_default_instance_),
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/cloud/vision/v1/geometry.proto", schemas, file_default_instances, TableStruct::offsets,
...
Vertex::Vertex(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_Vertex.base);
  SharedCtor();
...
NormalizedVertex::NormalizedVertex()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_NormalizedVertex.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:google.cloud.vision.v1.NormalizedVertex)
}
NormalizedVertex::NormalizedVertex(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_NormalizedVertex.base);
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:google.cloud.vision.v1.NormalizedVertex)
}
NormalizedVertex::NormalizedVertex(const NormalizedVertex& from)
  ...
  ::memcpy(&x_, &from.x_,
    static_cast<size_t>(reinterpret_cast<char*>(&y_) -
    reinterpret_cast<char*>(&x_)) + sizeof(y_));
  // @@protoc_insertion_point(copy_constructor:google.cloud.vision.v1.NormalizedVertex)
}
...
NormalizedVertex::~NormalizedVertex() {
  // @@protoc_insertion_point(destructor:google.cloud.vision.v1.NormalizedVertex)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:google.cloud.vision.v1.NormalizedVertex)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:google.cloud.vision.v1.NormalizedVertex)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:google.cloud.vision.v1.NormalizedVertex)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:google.cloud.vision.v1.NormalizedVertex)
  return false;
#undef DO_
}
...
void NormalizedVertex::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:google.cloud.vision.v1.NormalizedVertex)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:google.cloud.vision.v1.NormalizedVertex)
}

::google::protobuf::uint8* NormalizedVertex::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:google.cloud.vision.v1.NormalizedVertex)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:google.cloud.vision.v1.NormalizedVertex)
  return target;
}

size_t NormalizedVertex::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:google.cloud.vision.v1.NormalizedVertex)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:google.cloud.vision.v1.NormalizedVertex)
  GOOGLE_DCHECK_NE(&from, this);
  const NormalizedVertex* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const NormalizedVertex>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:google.cloud.vision.v1.NormalizedVertex)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:google.cloud.vision.v1.NormalizedVertex)
    MergeFrom(*source);
  }
}

void NormalizedVertex::MergeFrom(const NormalizedVertex& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:google.cloud.vision.v1.NormalizedVertex)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:google.cloud.vision.v1.NormalizedVertex)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:google.cloud.vision.v1.NormalizedVertex)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
BoundingPoly::BoundingPoly(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_BoundingPoly.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
Position::Position(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::scc_info_Position.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::cloud::vision::v1::Vertex* Arena::CreateMaybeMessage< ::google::cloud::vision::v1::Vertex >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::vision::v1::Vertex >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::cloud::vision::v1::NormalizedVertex* Arena::CreateMaybeMessage< ::google::cloud::vision::v1::NormalizedVertex >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::vision::v1::NormalizedVertex >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::cloud::vision::v1::BoundingPoly* Arena::CreateMaybeMessage< ::google::cloud::vision::v1::BoundingPoly >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::vision::v1::BoundingPoly >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::cloud::vision::v1::Position* Arena::CreateMaybeMessage< ::google::cloud::vision::v1::Position >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::vision::v1::Position >(arena);
}
}  // namespace protobuf
}  // namespace google
