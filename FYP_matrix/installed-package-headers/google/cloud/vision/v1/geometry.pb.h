...
#ifndef PROTOBUF_INCLUDED_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto
#define PROTOBUF_INCLUDED_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::cloud::vision::v1::BoundingPoly* Arena::CreateMaybeMessage<::google::cloud::vision::v1::BoundingPoly>(Arena*);
template<> ::google::cloud::vision::v1::NormalizedVertex* Arena::CreateMaybeMessage<::google::cloud::vision::v1::NormalizedVertex>(Arena*);
template<> ::google::cloud::vision::v1::Position* Arena::CreateMaybeMessage<::google::cloud::vision::v1::Position>(Arena*);
template<> ::google::cloud::vision::v1::Vertex* Arena::CreateMaybeMessage<::google::cloud::vision::v1::Vertex>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace cloud {
...
class NormalizedVertex : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.vision.v1.NormalizedVertex) */ {
 public:
  NormalizedVertex();
...
class BoundingPoly : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.vision.v1.BoundingPoly) */ {
 public:
  ...
  ::google::cloud::vision::v1::NormalizedVertex* mutable_normalized_vertices(int index);
  ::google::protobuf::RepeatedPtrField< ::google::cloud::vision::v1::NormalizedVertex >*
      mutable_normalized_vertices();
  const ::google::cloud::vision::v1::NormalizedVertex& normalized_vertices(int index) const;
  ::google::cloud::vision::v1::NormalizedVertex* add_normalized_vertices();
  const ::google::protobuf::RepeatedPtrField< ::google::cloud::vision::v1::NormalizedVertex >&
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::google::cloud::vision::v1::NormalizedVertex > normalized_vertices_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline float NormalizedVertex::x() const {
  // @@protoc_insertion_point(field_get:google.cloud.vision.v1.NormalizedVertex.x)
  return x_;
}
inline void NormalizedVertex::set_x(float value) {
  
  x_ = value;
  // @@protoc_insertion_point(field_set:google.cloud.vision.v1.NormalizedVertex.x)
}
...
inline float NormalizedVertex::y() const {
  // @@protoc_insertion_point(field_get:google.cloud.vision.v1.NormalizedVertex.y)
  return y_;
}
inline void NormalizedVertex::set_y(float value) {
  
  y_ = value;
  // @@protoc_insertion_point(field_set:google.cloud.vision.v1.NormalizedVertex.y)
}
...
inline ::google::cloud::vision::v1::NormalizedVertex* BoundingPoly::mutable_normalized_vertices(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.vision.v1.BoundingPoly.normalized_vertices)
  return normalized_vertices_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::google::cloud::vision::v1::NormalizedVertex >*
BoundingPoly::mutable_normalized_vertices() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.vision.v1.BoundingPoly.normalized_vertices)
  return &normalized_vertices_;
}
inline const ::google::cloud::vision::v1::NormalizedVertex& BoundingPoly::normalized_vertices(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.vision.v1.BoundingPoly.normalized_vertices)
  return normalized_vertices_.Get(index);
}
inline ::google::cloud::vision::v1::NormalizedVertex* BoundingPoly::add_normalized_vertices() {
  // @@protoc_insertion_point(field_add:google.cloud.vision.v1.BoundingPoly.normalized_vertices)
  return normalized_vertices_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::google::cloud::vision::v1::NormalizedVertex >&
BoundingPoly::normalized_vertices() const {
  // @@protoc_insertion_point(field_list:google.cloud.vision.v1.BoundingPoly.normalized_vertices)
  return normalized_vertices_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fcloud_2fvision_2fv1_2fgeometry_2eproto
